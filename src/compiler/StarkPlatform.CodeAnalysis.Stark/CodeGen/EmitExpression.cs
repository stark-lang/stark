...
namespace StarkPlatform.CodeAnalysis.Stark.CodeGen
{
    internal partial class CodeGenerator
    {
        ...
        /// </summary>
        private void TreatLongsAsNative(StarkPlatform.Cci.PrimitiveTypeCode tc)
        {
            if (tc == StarkPlatform.Cci.PrimitiveTypeCode.Int64)
            {
                _builder.EmitOpCode(ILOpCode.Conv_ovf_i);
            }
            else if (tc == StarkPlatform.Cci.PrimitiveTypeCode.UInt64)
            {
        ...
        private void EmitArrayLength(BoundArrayLength expression, bool used)
        {
            ...
            var typeFrom = typeTo.IsUnsigned() ? StarkPlatform.Cci.PrimitiveTypeCode.UIntPtr : StarkPlatform.Cci.PrimitiveTypeCode.IntPtr;
