    ...
    internal partial class CodeGenerator
    {
                ...
                case ConversionKind.IntegerToPointer:
                    ...
                    switch (fromPredefTypeKind)
                    {
                        ...
                        default:
                            ...
                            Debug.Assert(
                                toPredefTypeKind == StarkPlatform.Cci.PrimitiveTypeCode.IntPtr ||
                                toPredefTypeKind == StarkPlatform.Cci.PrimitiveTypeCode.UIntPtr ||
                                toPredefTypeKind == StarkPlatform.Cci.PrimitiveTypeCode.Pointer);
                            break;
                    }
#endif
        ...
        private MethodSymbol DelegateConstructor(SyntaxNode syntax, TypeSymbol delegateType)
        {
            foreach (var possibleCtor in delegateType.GetMembers(WellKnownMemberNames.InstanceConstructorName))
            {
                ...
                if (p1t == SpecialType.System_Int || p1t == SpecialType.System_UInt)
                {
                    return m;
                }
            }
