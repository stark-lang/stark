        ...
        private void EmitConversionToEnumUnderlyingType(BoundBinaryOperator expression, bool @checked)
        {
            ...
            switch (type)
            {
                case SpecialType.System_UInt8:
                    _builder.EmitNumericConversion(StarkPlatform.Cci.PrimitiveTypeCode.Int32, StarkPlatform.Cci.PrimitiveTypeCode.UInt8, @checked);
                    break;
                case SpecialType.System_Int8:
                    _builder.EmitNumericConversion(StarkPlatform.Cci.PrimitiveTypeCode.Int32, StarkPlatform.Cci.PrimitiveTypeCode.Int8, @checked);
                    break;
                case SpecialType.System_Int16:
                    _builder.EmitNumericConversion(StarkPlatform.Cci.PrimitiveTypeCode.Int32, StarkPlatform.Cci.PrimitiveTypeCode.Int16, @checked);
                    break;
                case SpecialType.System_UInt16:
                    _builder.EmitNumericConversion(StarkPlatform.Cci.PrimitiveTypeCode.Int32, StarkPlatform.Cci.PrimitiveTypeCode.UInt16, @checked);
                    break;
            }
        }
