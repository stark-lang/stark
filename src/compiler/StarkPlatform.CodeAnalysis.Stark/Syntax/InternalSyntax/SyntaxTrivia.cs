...
namespace StarkPlatform.CodeAnalysis.Stark.Syntax.InternalSyntax
{
    internal class SyntaxTrivia : CSharpSyntaxNode
    {
        ...
        public static implicit operator StarkPlatform.CodeAnalysis.SyntaxTrivia(SyntaxTrivia trivia)
        {
            return new StarkPlatform.CodeAnalysis.SyntaxTrivia(default(StarkPlatform.CodeAnalysis.SyntaxToken), trivia, position: 0, index: 0);
        }
