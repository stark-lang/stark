...
namespace StarkPlatform.CodeAnalysis.Stark
{
    public static class SyntaxExtensions
    {
        ...
        {
            return SyntaxNormalizer.Normalize(token, indentation, StarkPlatform.CodeAnalysis.SyntaxNodeExtensions.DefaultEOL, elasticTrivia);
        }
        ...
        public static SyntaxToken NormalizeWhitespace(this SyntaxToken token,
            string indentation = StarkPlatform.CodeAnalysis.SyntaxNodeExtensions.DefaultIndentation,
            string eol = StarkPlatform.CodeAnalysis.SyntaxNodeExtensions.DefaultEOL,
        ...
        {
            return SyntaxNormalizer.Normalize(list, indentation, StarkPlatform.CodeAnalysis.SyntaxNodeExtensions.DefaultEOL, elasticTrivia);
        }
