...
namespace StarkPlatform.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        {
            internal static bool IsPostfixIncrementOrDecrement(Stark.UnaryOperatorKind operatorKind)
            {
                switch (operatorKind.Operator())
                {
                    case Stark.UnaryOperatorKind.PostfixIncrement:
                    case Stark.UnaryOperatorKind.PostfixDecrement:
                        return true;
            ...
            internal static bool IsDecrement(Stark.UnaryOperatorKind operatorKind)
            {
                switch (operatorKind.Operator())
                {
                    case Stark.UnaryOperatorKind.PrefixDecrement:
                    case Stark.UnaryOperatorKind.PostfixDecrement:
                        return true;
            ...
            internal static UnaryOperatorKind DeriveUnaryOperatorKind(Stark.UnaryOperatorKind operatorKind)
            {
                switch (operatorKind.Operator())
                {
                    case Stark.UnaryOperatorKind.UnaryPlus:
                        return UnaryOperatorKind.Plus;

                    case Stark.UnaryOperatorKind.UnaryMinus:
                        return UnaryOperatorKind.Minus;

                    case Stark.UnaryOperatorKind.LogicalNegation:
                        return UnaryOperatorKind.Not;

                    case Stark.UnaryOperatorKind.BitwiseComplement:
                        return UnaryOperatorKind.BitwiseNegation;

                    case Stark.UnaryOperatorKind.True:
                        return UnaryOperatorKind.True;

                    case Stark.UnaryOperatorKind.False:
            ...
            internal static BinaryOperatorKind DeriveBinaryOperatorKind(Stark.BinaryOperatorKind operatorKind)
            {
                switch (operatorKind.OperatorWithLogical())
                {
                    case Stark.BinaryOperatorKind.Addition:
                        return BinaryOperatorKind.Add;

                    case Stark.BinaryOperatorKind.Subtraction:
                        return BinaryOperatorKind.Subtract;

                    case Stark.BinaryOperatorKind.Multiplication:
                        return BinaryOperatorKind.Multiply;

                    case Stark.BinaryOperatorKind.Division:
                        return BinaryOperatorKind.Divide;

                    case Stark.BinaryOperatorKind.Remainder:
                        return BinaryOperatorKind.Remainder;

                    case Stark.BinaryOperatorKind.LeftShift:
                        return BinaryOperatorKind.LeftShift;

                    case Stark.BinaryOperatorKind.RightShift:
                        return BinaryOperatorKind.RightShift;

                    case Stark.BinaryOperatorKind.And:
                        return BinaryOperatorKind.And;

                    case Stark.BinaryOperatorKind.Or:
                        return BinaryOperatorKind.Or;

                    case Stark.BinaryOperatorKind.Xor:
                        return BinaryOperatorKind.ExclusiveOr;

                    case Stark.BinaryOperatorKind.LessThan:
                        return BinaryOperatorKind.LessThan;

                    case Stark.BinaryOperatorKind.LessThanOrEqual:
                        return BinaryOperatorKind.LessThanOrEqual;

                    case Stark.BinaryOperatorKind.Equal:
                        return BinaryOperatorKind.Equals;

                    case Stark.BinaryOperatorKind.NotEqual:
                        return BinaryOperatorKind.NotEquals;

                    case Stark.BinaryOperatorKind.GreaterThanOrEqual:
                        return BinaryOperatorKind.GreaterThanOrEqual;

                    case Stark.BinaryOperatorKind.GreaterThan:
                        return BinaryOperatorKind.GreaterThan;

                    case Stark.BinaryOperatorKind.LogicalAnd:
                        return BinaryOperatorKind.ConditionalAnd;

                    case Stark.BinaryOperatorKind.LogicalOr:
