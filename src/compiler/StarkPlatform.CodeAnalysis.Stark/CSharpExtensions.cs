...
using StarkPlatform.CodeAnalysis.Syntax;
...
namespace StarkPlatform.CodeAnalysis
{
    public static class CSharpExtensions
    {
        ...
        {
            return (object)token.Language == (object)LanguageNames.Stark ? (SyntaxKind)token.RawContextualKind : SyntaxKind.None;
        }
        ...
        /// <param name="kind">The <see cref="Stark.SyntaxKind"/> to test for.</param>
...
namespace StarkPlatform.CodeAnalysis.Stark
{
    public static class CSharpExtensions
    {
        ...
        /// <summary>
        /// Returns this list as a <see cref="StarkPlatform.CodeAnalysis.SeparatedSyntaxList&lt;TNode&gt;"/>.
        /// </summary>
        ...
        {
            if (conversionExpression.Language == LanguageNames.Stark)
            {
        ...
        public static Conversion GetInConversion(this ICompoundAssignmentOperation compoundAssignment)
        {
            ...
            if (compoundAssignment.Language == LanguageNames.Stark)
            {
        ...
        /// </summary>
        public static IAliasSymbol GetDeclaredSymbol(this SemanticModel semanticModel, ImportDirectiveSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            var csmodel = semanticModel as CSharpSemanticModel;
            return csmodel?.GetDeclaredSymbol(declarationSyntax, cancellationToken);
        }
