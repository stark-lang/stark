...
namespace StarkPlatform.CodeAnalysis.Stark
{
    internal partial class Binder
    {
            ...
            ConstantValue operandConstantValue)
        {
            ...
            // SPEC VIOLATION:  See StarkPlatform.CodeAnalysis.Stark.UnitTests.SyntaxBinderTests.TestAsOperator_SpecErrorCase() test for an example.
        ...
        /// myshort->int).
        /// </remarks>
        private BoundExpression BindConditionalOperator(IfExpressionSyntax node, DiagnosticBag diagnostics)
        {
