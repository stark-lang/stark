...
namespace StarkPlatform.CodeAnalysis.Stark
{
    ...
    internal sealed class AnalyzedArguments
    {
        ...
        {
            return RefKinds.Count > 0 ? RefKinds[i] : StarkPlatform.CodeAnalysis.RefKind.None;
        }
        ...
        public bool HasDynamicArgument
        {
            get
            {
                ...
                for (int i = 0; i < Arguments.Count; i++)
                {
                    ...
                    if ((object)argument.Type != null && argument.Type.IsDynamic() && (!hasRefKinds || RefKinds[i] == StarkPlatform.CodeAnalysis.RefKind.None))
                    {
