...
namespace StarkPlatform.CodeAnalysis.Stark.Symbols.Metadata.PE
{
    ...
    internal sealed class PEFieldSymbol : FieldSymbol
    {
        ...
        private ConstantValue _lazyConstantValue = StarkPlatform.CodeAnalysis.ConstantValue.Unset; // Indicates an uninitialized ConstantValue
        ...
        {
            if (_lazyConstantValue == StarkPlatform.CodeAnalysis.ConstantValue.Unset)
            {
                ...
                Interlocked.CompareExchange(
                    ...
                    value,
                    StarkPlatform.CodeAnalysis.ConstantValue.Unset);
            }
