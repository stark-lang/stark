    ...
    internal abstract class MissingMetadataTypeSymbol : ErrorTypeSymbol
    {
        ...
        internal class TopLevel : MissingMetadataTypeSymbol
        {
            ...
            public override int GetHashCode()
            {
                ...
                if (this.SpecialType == StarkPlatform.CodeAnalysis.SpecialType.System_Object)
                {
                    return (int)StarkPlatform.CodeAnalysis.SpecialType.System_Object;
                }
            ...
            internal override bool Equals(TypeSymbol t2, TypeCompareKind comparison)
            {
                ...
                if ((comparison & TypeCompareKind.IgnoreDynamic) != 0 &&
                    ...
                    this.SpecialType == StarkPlatform.CodeAnalysis.SpecialType.System_Object)
                {
                    return true;
                }
