...
namespace StarkPlatform.CodeAnalysis.Stark.Symbols
{
    ...
    internal sealed partial class AnonymousTypeManager
    {
        ...
        private AnonymousTypeTemplateSymbol CreatePlaceholderTemplate(StarkPlatform.CodeAnalysis.Emit.AnonymousTypeKey key)
        {
        ...
        internal static StarkPlatform.CodeAnalysis.Emit.AnonymousTypeKey GetAnonymousTypeKey(NamedTypeSymbol type)
        {
            return ((AnonymousTypeTemplateSymbol)type).GetAnonymousTypeKey();
        }

        internal IReadOnlyDictionary<StarkPlatform.CodeAnalysis.Emit.AnonymousTypeKey, StarkPlatform.CodeAnalysis.Emit.AnonymousTypeValue> GetAnonymousTypeMap()
        {
            var result = new Dictionary<StarkPlatform.CodeAnalysis.Emit.AnonymousTypeKey, StarkPlatform.CodeAnalysis.Emit.AnonymousTypeValue>();
            ...
            foreach (var template in templates)
            {
                ...
                var value = new StarkPlatform.CodeAnalysis.Emit.AnonymousTypeValue(nameAndIndex.Name, nameAndIndex.Index, template);
