...
namespace StarkPlatform.CodeAnalysis.Stark.Symbols
{
    ...
    internal abstract partial class SourceMemberContainerTypeSymbol : NamedTypeSymbol
    {
        ...
        private struct Flags
        {
            ...
            {
                get { return (ManagedKind)((_flags2 >> ManagedKindOffset) & ManagedKindMask); }
            }
        ...
        private bool TypeOverridesObjectMethod(string name)
        {
            ...
            {
                if (method.IsOverride && method.GetConstructedLeastOverriddenMethod(this).ContainingType.SpecialType == StarkPlatform.CodeAnalysis.SpecialType.System_Object)
                {
                    return true;
                }
            }
