...
namespace StarkPlatform.CodeAnalysis.Stark.Symbols
{
    internal sealed class SourcePropertySymbol : PropertySymbol, IAttributeTargetSymbol
    {
           ...
           DiagnosticBag diagnostics)
        {
            ...
            {
                var modifierType = bodyBinder.GetWellKnownType(WellKnownType.system_runtime_InAttribute, diagnostics, syntax.Type);
        ...
        {
            get { return (IsStatic ? 0 : StarkPlatform.Cci.CallingConvention.HasThis); }
        }
