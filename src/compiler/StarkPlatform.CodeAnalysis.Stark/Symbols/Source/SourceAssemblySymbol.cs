...
using CommonAssemblyWellKnownAttributeData = StarkPlatform.CodeAnalysis.CommonAssemblyWellKnownAttributeData<StarkPlatform.CodeAnalysis.Stark.Symbols.NamedTypeSymbol>;
