...
using StarkPlatform.CodeAnalysis.Stark.CodeGen;
...
namespace StarkPlatform.CodeAnalysis.Stark
{
    ...
    internal sealed class SyntheticBoundNodeFactory
    {
        ...
        {
            return new BoundBlock(Syntax, locals, localFunctions, false, statements) { WasCompilerGenerated = true };
        }
        ...
        public BoundIsOperator Is(BoundExpression operand, TypeSymbol type)
        {
            ...
            return new BoundIsOperator(this.Syntax, operand, Type(type), c, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean)) { WasCompilerGenerated = true };
        }

        public BoundBinaryOperator LogicalAnd(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.LogicalBoolAnd, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator LogicalOr(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.LogicalBoolOr, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32Equal, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator ObjectEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.ObjectEqual, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator ObjectNotEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.ObjectNotEqual, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntNotEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32NotEqual, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntLessThan(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32LessThan, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean), left, right);
        }
        ...
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Int32)) { WasCompilerGenerated = true };
        }

        public BoundLiteral Literal(uint value)
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_UInt32)) { WasCompilerGenerated = true };
        }
        ...
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Boolean)) { WasCompilerGenerated = true };
        }
        ...
        public BoundLiteral StringLiteral(ConstantValue stringConst)
        {
            ...
            return new BoundLiteral(Syntax, stringConst, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_String)) { WasCompilerGenerated = true };
        }
        ...
        public BoundArrayLength ArrayLength(BoundExpression array)
        {
            ...
            return new BoundArrayLength(Syntax, array, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Int32));
        }
        ...
        {
            return Throw(Null(Compilation.GetWellKnownType(StarkPlatform.CodeAnalysis.WellKnownType.system_Exception)));
        }
        ...
        {
            return new BoundSizeOfOperator(Syntax, Type(type), Binder.GetConstantSizeOf(type), SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Int32)) { WasCompilerGenerated = true };
        }
        ...
        internal BoundExpression ConstructorInfo(MethodSymbol ctor)
        {
            return new BoundMethodInfo(
                ...
                WellKnownType(StarkPlatform.CodeAnalysis.WellKnownType.system_Reflection_ConstructorInfo))
            { WasCompilerGenerated = true };
        }
        ...
        public BoundExpression MethodDefIndex(MethodSymbol method)
        {
            return new BoundMethodDefIndex(
                Syntax,
                method,
                SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Int32))
            { WasCompilerGenerated = true };
        }
        ...
        {
            return new BoundModuleVersionId(Syntax, WellKnownType(StarkPlatform.CodeAnalysis.WellKnownType.system_Guid)) { WasCompilerGenerated = true };
        }

        public BoundExpression ModuleVersionIdString()
        {
            return new BoundModuleVersionIdString(Syntax, SpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_String)) { WasCompilerGenerated = true };
        }
        ...
        public BoundExpression MethodInfo(MethodSymbol method)
        {
            ...
            if (!method.ContainingType.IsValueType || !StarkPlatform.CodeAnalysis.Stark.CodeGen.CodeGenerator.MayUseCallForStructMethod(method))
            {
            ...
            return new BoundMethodInfo(
                ...
                WellKnownType(StarkPlatform.CodeAnalysis.WellKnownType.system_Reflection_MethodInfo))
            { WasCompilerGenerated = true };
        }
        ...
        public BoundExpression FieldInfo(FieldSymbol field)
        {
            return new BoundFieldInfo(
                ...
                WellKnownType(StarkPlatform.CodeAnalysis.WellKnownType.system_Reflection_FieldInfo))
            { WasCompilerGenerated = true };
        }
