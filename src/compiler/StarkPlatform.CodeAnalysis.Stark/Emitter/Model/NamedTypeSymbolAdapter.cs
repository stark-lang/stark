...
using StarkPlatform.CodeAnalysis.Stark.Symbols.Metadata.PE;
        ...
        Cci.ISpecializedNestedTypeReference
    {
        ...
        Cci.ITypeReference Cci.ITypeDefinition.GetBaseClass(EmitContext context)
        {
            ...
            if (this.IsScriptClass)
            {
                ...
                baseType = this.ContainingAssembly.GetSpecialType(StarkPlatform.CodeAnalysis.SpecialType.System_Object);
            }
