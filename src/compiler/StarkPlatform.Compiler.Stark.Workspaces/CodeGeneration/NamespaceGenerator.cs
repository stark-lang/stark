...
using static StarkPlatform.Compiler.CodeGeneration.CodeGenerationHelpers;
using static StarkPlatform.Compiler.Stark.CodeGeneration.CSharpCodeGenerationHelpers;
...
namespace StarkPlatform.Compiler.Stark.CodeGeneration
{
    internal static class NamespaceGenerator
    {
        ...
        private static SyntaxList<ImportDirectiveSyntax> GenerateUsingDirectives(INamespaceSymbol innermostNamespace)
        {
            var usingDirectives =
        ...
        private static ImportDirectiveSyntax GenerateUsingDirective(ISymbol symbol)
        {
            if (symbol is IAliasSymbol alias)
            {
                ...
                if (name != null)
                {
                    return SyntaxFactory.ImportDirective(
