...
namespace StarkPlatform.Compiler.Stark.CodeGeneration
{
    internal static class PropertyGenerator
    {
        ...
        private static bool TryGetArrowExpressionBody(
            ...
            out ArrowExpressionClauseSyntax arrowExpression, out SyntaxToken eosToken)
        {
            ...
            if (accessor.ExpressionBody != null)
            {
                ...
                eosToken = accessor.EosToken;
                return true;
            }

            return accessor.Body.TryConvertToArrowExpressionBody(
                declaratoinKind, options, preference, out arrowExpression, out eosToken);
        }
