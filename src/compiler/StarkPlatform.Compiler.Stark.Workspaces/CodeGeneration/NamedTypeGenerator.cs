...
namespace StarkPlatform.Compiler.Stark.CodeGeneration
{
    internal static class NamedTypeGenerator
    {
        ...
        private static SyntaxList<AttributeSyntax> GenerateAttributeDeclarations(
        ...
        private static ImplementListSyntax GenerateBaseList(INamedTypeSymbol namedType)
        {
            ...
            if (namedType.TypeKind == TypeKind.Class && namedType.BaseType != null && namedType.BaseType.SpecialType != StarkPlatform.Compiler.SpecialType.System_Object)
            {
