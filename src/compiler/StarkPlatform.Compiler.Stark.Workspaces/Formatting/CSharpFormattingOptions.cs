...
#if CODE_STYLE
using CSharpWorkspaceResources = StarkPlatform.Compiler.Stark.CSharpCodeStyleResources;
using WorkspacesResources = StarkPlatform.Compiler.CodeStyleResources;
#endif
