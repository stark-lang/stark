...
using StarkPlatform.Compiler.Recommendations;
using StarkPlatform.Compiler.Shared.Extensions;
using StarkPlatform.Compiler.Shared.Extensions.ContextQuery;
using Roslyn.Utilities;

namespace StarkPlatform.Compiler.Stark.Recommendations
{
    [ExportLanguageService(typeof(IRecommendationService), LanguageNames.Stark), Shared]
    internal class CSharpRecommendationService : AbstractRecommendationService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (token.Kind() == SyntaxKind.SemicolonToken &&
                token.Parent.IsKind(SyntaxKind.ImportDirective) &&
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (nameBinding.Symbol is INamespaceOrTypeSymbol symbol)
            {
                ...
                var usingDirective = name.GetAncestorOrThis<ImportDirectiveSyntax>();
