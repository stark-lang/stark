...
namespace StarkPlatform.Compiler.SignatureHelp
{
        ...
        internal class SymbolKeySignatureHelpItem : SignatureHelpItem, IEquatable<SymbolKeySignatureHelpItem>
        {
            ...
            public bool Equals(SymbolKeySignatureHelpItem obj)
            {
                return ReferenceEquals(this, obj) ||
                    (obj?.SymbolKey != null &&
                     this.SymbolKey != null &&
                     Compiler.SymbolKey.GetComparer(ignoreCase: false, ignoreAssemblyKeys: false).Equals(this.SymbolKey.Value, obj.SymbolKey.Value));
            }
            ...
            public override int GetHashCode()
            {
                ...
                var comparer = Compiler.SymbolKey.GetComparer(ignoreCase: false, ignoreAssemblyKeys: false);
