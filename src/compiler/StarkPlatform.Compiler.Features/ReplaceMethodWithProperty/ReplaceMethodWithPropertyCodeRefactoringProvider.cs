...
namespace StarkPlatform.Compiler.ReplaceMethodWithProperty
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = nameof(ReplaceMethodWithPropertyCodeRefactoringProvider)), Shared]
