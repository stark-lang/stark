...
using StarkPlatform.Compiler.Diagnostics.Log;
...
namespace StarkPlatform.Compiler.Diagnostics
{
    ...
    {
        private const string CSharpCompilerAnalyzerTypeName = "StarkPlatform.Compiler.Diagnostics.CSharp.CSharpCompilerDiagnosticAnalyzer";
        private const string VisualBasicCompilerAnalyzerTypeName = "StarkPlatform.Compiler.Diagnostics.VisualBasic.VisualBasicCompilerDiagnosticAnalyzer";
        ...
        private static string Choose(string language, string noLanguageMessage, string csharpMessage, string vbMessage)
        {
            ...
            return language == LanguageNames.Stark ? csharpMessage : vbMessage;
        }
