...
using StarkPlatform.Compiler.ChangeNamespace;
...
namespace StarkPlatform.Compiler.CodeRefactorings.SyncNamespace
{
        ...
        where TMemberDeclarationSyntax : SyntaxNode
    {
        internal sealed class State
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                // For example, if the default namespace is `StarkPlatform.Compiler`, and declared
