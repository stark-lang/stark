...
namespace StarkPlatform.Compiler.ReplacePropertyWithMethods
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = nameof(ReplacePropertyWithMethodsCodeRefactoringProvider)), Shared]
