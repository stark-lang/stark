...
namespace StarkPlatform.Compiler.IntroduceVariable
{
    ...
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = PredefinedCodeRefactoringProviderNames.IntroduceVariable), Shared]
