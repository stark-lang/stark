...
using StarkPlatform.Compiler.CodeActions.WorkspaceServices;
using StarkPlatform.Compiler.Diagnostics;
using StarkPlatform.Compiler.LanguageServices;
using StarkPlatform.Compiler.NamingStyles;
using StarkPlatform.Compiler.Rename;
using StarkPlatform.Compiler.Shared.Extensions;
using Roslyn.Utilities;

namespace StarkPlatform.Compiler.CodeFixes.NamingStyles
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.ApplyNamingStyle), Shared]
