...
namespace StarkPlatform.Compiler.PreferFrameworkType
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.PreferFrameworkType), Shared]
