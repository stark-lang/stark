...
using StarkPlatform.Compiler.GenerateMember.GenerateConstructor;
using StarkPlatform.Compiler.GenerateType;
...
using StarkPlatform.Compiler.Shared.Options;
using StarkPlatform.Compiler.Text;
using Roslyn.Utilities;
using StarkPlatform.Compiler.Utilities;
using System.Collections.Immutable;

namespace StarkPlatform.Compiler.Stark.GenerateType
{
    [ExportLanguageService(typeof(IGenerateTypeService), LanguageNames.Stark), Shared]
        ...
        AbstractGenerateTypeService<CSharpGenerateTypeService, SimpleNameSyntax, ObjectCreationExpressionSyntax, ExpressionSyntax, TypeDeclarationSyntax, ArgumentSyntax>
    {
        ...
        internal override async Task<Solution> TryAddUsingsOrImportToDocumentAsync(Solution updatedSolution, SyntaxNode modifiedRoot, Document document, SimpleNameSyntax simpleName, string includeUsingsOrImports, CancellationToken cancellationToken)
        {
            ...
            {
                var usingDirective = SyntaxFactory.ImportDirective(SyntaxFactory.ParseName(includeUsingsOrImports));
