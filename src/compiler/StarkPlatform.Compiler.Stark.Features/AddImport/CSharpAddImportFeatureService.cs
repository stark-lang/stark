...
using StarkPlatform.Compiler.AddImport;
...
using static StarkPlatform.Compiler.Stark.AddImport.AddImportDiagnosticIds;

namespace StarkPlatform.Compiler.Stark.AddImport
{
    [ExportLanguageService(typeof(IAddImportFeatureService), LanguageNames.Stark), Shared]
    internal class CSharpAddImportFeatureService : AbstractAddImportFeatureService<SimpleNameSyntax>
    {
            ...
            Document document, bool placeSystemNamespaceFirst, CancellationToken cancellationToken)
        {
            ...
            var usingDirective = SyntaxFactory.ImportDirective(
        ...
        private (ImportDirectiveSyntax, bool hasExistingImport) GetUsingDirective(
            Document document,
            INamespaceOrTypeSymbol namespaceOrTypeSymbol,
            SemanticModel semanticModel,
            ...
            SyntaxNode contextNode)
        {
            ...
            var dummyUsing = SyntaxFactory.ImportDirective(nameSyntax);
            ...
            var usingDirective = SyntaxFactory.ImportDirective(nameSyntax)
                                              .WithAdditionalAnnotations(Formatter.Annotation);
