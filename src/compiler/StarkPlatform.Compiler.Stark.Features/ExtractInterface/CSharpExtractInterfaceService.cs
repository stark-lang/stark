...
using StarkPlatform.Compiler.ExtractInterface;
...
namespace StarkPlatform.Compiler.Stark.ExtractInterface
{
    [ExportLanguageService(typeof(AbstractExtractInterfaceService), LanguageNames.Stark), Shared]
