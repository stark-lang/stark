...
using StarkPlatform.Compiler.Fading;
using StarkPlatform.Compiler.Text;
using StarkPlatform.Compiler.Utilities;
using Roslyn.Utilities;

namespace StarkPlatform.Compiler.Stark.RemoveUnreachableCode
{
    ...
    internal class CSharpRemoveUnreachableCodeDiagnosticAnalyzer : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
        ...
        private void AnalyzeSemanticModel(SemanticModelAnalysisContext context)
        {
            ...
            var fadeCode = options.Services.Workspace.Options.GetOption(FadingOptions.FadeOutUnreachableCode, LanguageNames.Stark);
