...
namespace StarkPlatform.Compiler.Stark.TypeStyle
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.UseExplicitType), Shared]
    internal class UseExplicitTypeCodeFixProvider : SyntaxEditorBasedCodeFixProvider
    {
            ...
            SyntaxNode node, CancellationToken cancellationToken)
        {
            ...
            //else if (declarationContext is ForEachVariableStatementSyntax forEach)
            //{
