...
using StarkPlatform.Compiler.GenerateMember.GenerateDefaultConstructors;
...
namespace StarkPlatform.Compiler.Stark.GenerateMember.GenerateDefaultConstructors
{
