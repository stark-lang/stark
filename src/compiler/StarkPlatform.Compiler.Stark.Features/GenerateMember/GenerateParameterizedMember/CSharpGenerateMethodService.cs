...
using StarkPlatform.Compiler.Stark.GenerateMember.GenerateParameterizedMember;
using StarkPlatform.Compiler.Stark.Symbols;
using StarkPlatform.Compiler.Stark.Syntax;
using StarkPlatform.Compiler.GenerateMember.GenerateParameterizedMember;
...
namespace StarkPlatform.Compiler.Stark.GenerateMember.GenerateMethod
{
    [ExportLanguageService(typeof(IGenerateParameterizedMemberService), LanguageNames.Stark), Shared]
