...
using StarkPlatform.Compiler.Stark.GenerateMember.GenerateMethod;
...
namespace StarkPlatform.Compiler.Stark.GenerateMember.GenerateParameterizedMember
{
    [ExportLanguageService(typeof(IGenerateConversionService), LanguageNames.Stark), Shared]
