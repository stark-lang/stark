...
using StarkPlatform.Compiler.ConvertAutoPropertyToFullProperty;
...
using StarkPlatform.Compiler.Shared.Naming;
using StarkPlatform.Compiler.Shared.Utilities;
using static StarkPlatform.Compiler.Diagnostics.Analyzers.NamingStyles.SymbolSpecification;

namespace StarkPlatform.Compiler.Stark.ConvertAutoPropertyToFullProperty
{
