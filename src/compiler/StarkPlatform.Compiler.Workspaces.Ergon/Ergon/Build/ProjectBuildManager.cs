...
namespace StarkPlatform.Compiler.Ergon.Build
{
    internal class ProjectBuildManager
    {
        ...
        private ErgonProjectCollection _batchBuildProjectCollection;
        //private ErgonDiagnosticLogger _batchBuildLogger;
        ...
        //private async Task<ErgonBuildResult> BuildAsync(MSB.Execution.BuildRequestData requestData, CancellationToken cancellationToken)
        //{
        ...
        //private Task<ErgonBuildResult> BuildAsync(MSB.Execution.BuildManager buildManager, MSB.Execution.BuildRequestData requestData, CancellationToken cancellationToken)
        //{
        //    var taskSource = new TaskCompletionSource<ErgonBuildResult>();
