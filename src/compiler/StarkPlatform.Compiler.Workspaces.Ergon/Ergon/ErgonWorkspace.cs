...
namespace StarkPlatform.Compiler.Ergon
{
    ...
    public sealed class ErgonWorkspace : Workspace
    {
        ...
        /// </summary>
        public static ErgonWorkspace Create()
        {
        ...
        public static ErgonWorkspace Create(IDictionary<string, string> properties)
        {
        ...
        public static ErgonWorkspace Create(HostServices hostServices)
        {
