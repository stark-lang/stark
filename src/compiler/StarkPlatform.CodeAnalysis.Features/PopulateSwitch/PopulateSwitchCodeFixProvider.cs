...
namespace StarkPlatform.CodeAnalysis.PopulateSwitch
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.PopulateSwitch), Shared]
