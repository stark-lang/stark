...
namespace CSharpSyntaxGenerator
{
    internal class TestWriter : AbstractFileWriter
    {
        ...
        private void WriteFile()
        {
            ...
            WriteLine("namespace StarkPlatform.Compiler.Stark.UnitTests");
            OpenBlock();
        ...
        private void WriteNodeGenerator(Node node, bool isGreen)
        {
            ...
            var internalNamespace = isGreen ? "StarkPlatform.Compiler.Syntax.InternalSyntax." : "";
            var csharpNamespace = isGreen ? "StarkPlatform.Compiler.Stark.Syntax.InternalSyntax." : "";
