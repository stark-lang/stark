...
namespace CSharpSyntaxGenerator
{
    internal class TestWriter : AbstractFileWriter
    {
        ...
        private void WriteFile()
        {
            ...
            WriteLine("namespace StarkPlatform.CodeAnalysis.Stark.UnitTests");
            OpenBlock();
        ...
        private void WriteNodeGenerator(Node node, bool isGreen)
        {
            ...
            var internalNamespace = isGreen ? "StarkPlatform.CodeAnalysis.Syntax.InternalSyntax." : "";
            var csharpNamespace = isGreen ? "StarkPlatform.CodeAnalysis.Stark.Syntax.InternalSyntax." : "";
