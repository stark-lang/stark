...
namespace StarkPlatform.Reflection
{
    ...
    internal static class Throw
    {
        ...
        {
            throw new ArgumentException(StarkPlatform.Reflection.Resources.SR.Format(SR.UnexpectedHandleKind, kind));
        }
        ...
        {
            throw new InvalidOperationException(StarkPlatform.Reflection.Resources.SR.Format(SR.LabelNotMarked, id));
        }
        ...
        {
            throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.MetadataTableNotSorted, tableIndex));
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        internal static void InvalidOperation_TableNotSorted(TableIndex tableIndex)
        {
            throw new InvalidOperationException(StarkPlatform.Reflection.Resources.SR.Format(SR.MetadataTableNotSorted, tableIndex));
        }
