...
namespace StarkPlatform.Reflection.Metadata
{
    ...
    public sealed partial class MetadataReader
    {
        ...
        internal unsafe MetadataReader(byte* metadata, int length, MetadataReaderOptions options, MetadataStringDecoder utf8Decoder, object memoryOwner)
        {
            ...
            {
                throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.ModuleTableInvalidNumberOfRows, this.ModuleTable.NumberOfRows));
            }
        ...
        private void ReadMetadataTableHeader(ref BlobReader reader, out HeapSizes heapSizes, out int[] metadataTableRowCounts, out TableMask sortedTables)
        {
            ...
            {
                throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.UnknownTables, presentTables));
            }
        ...
        private static int[] ReadMetadataTableRowCounts(ref BlobReader memReader, ulong presentTableMask)
        {
            ...
            for (int i = 0; i < rowCounts.Length; i++)
            {
                if ((presentTableMask & currentTableBit) != 0)
                {
                    ...
                    {
                        throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.InvalidRowCount, rowCount));
                    }
        ...
        internal static void ReadStandalonePortablePdbStream(MemoryBlock pdbStreamBlock, int pdbStreamOffset, out DebugMetadataHeader debugMetadataHeader, out int[] externalTableRowCounts)
        {
            ...
            {
                throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.InvalidEntryPointToken, entryPointToken));
            }
            ...
            {
                throw new BadImageFormatException(StarkPlatform.Reflection.Resources.SR.Format(SR.UnknownTables, externalTableMask));
            }
