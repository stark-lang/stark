    ...
    public sealed class MetadataAggregator
    {
            ...
            IReadOnlyList<MetadataReader> deltaReaders)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(StarkPlatform.Reflection.Resources.SR.Format(SR.ExpectedListOfSize, MetadataTokens.TableCount), nameof(baseTableRowCounts));
                }
                ...
                {
                    throw new ArgumentException(StarkPlatform.Reflection.Resources.SR.Format(SR.ExpectedListOfSize, MetadataTokens.HeapCount), nameof(baseTableRowCounts));
                }
            }
