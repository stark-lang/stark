...
namespace StarkPlatform.Reflection.Metadata.Ecma335
{
    public sealed partial class MetadataBuilder
    {
            ...
            int guidHeapStartOffset = 0)
        {
            ...
            {
                throw new ArgumentException(StarkPlatform.Reflection.Resources.SR.Format(SR.ValueMustBeMultiple, BlobUtilities.SizeOfGuid), nameof(guidHeapStartOffset));
            }
        ...
        /// (see https://github.com/dotnet/corefx/blob/master/src/StarkPlatform.Reflection.Metadata/specs/PortablePdb-Metadata.md#DocumentNameBlob).
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="value"/> is null.</exception>
