...
namespace StarkPlatform.Compiler.Host.Mef
{
    public class MefHostServices : HostServices, IMefHostExportProvider
    {
        ...
        private static ImmutableArray<Assembly> LoadDefaultAssemblies()
        {
            ...
            {
                "StarkPlatform.Compiler.Workspaces",
                "StarkPlatform.Compiler.Stark.Workspaces",
                "StarkPlatform.Compiler.VisualBasic.Workspaces",
                "StarkPlatform.Compiler.Features",
                "StarkPlatform.Compiler.Stark.Features",
                "StarkPlatform.Compiler.VisualBasic.Features"
            };
