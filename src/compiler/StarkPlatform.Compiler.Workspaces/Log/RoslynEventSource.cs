...
namespace StarkPlatform.Compiler.Internal.Log
{
    /// <summary>
    ...
    /// Main\Tools\Source\TraceParserGen\bin\Debug\TraceParserGen.exe StarkPlatform.Compiler.Workspaces.dll -eventsource:RoslynEventSource
    /// 
    /// Use this command to register the ETW manifest on any machine where you need to decode events in xperf/etlstackbrowse:
    /// "\\clrmain\tools\managed\etw\eventRegister\bin\Debug\eventRegister.exe" StarkPlatform.Compiler.Workspaces.dll
    /// </summary>
    ...
    internal sealed class RoslynEventSource : EventSource
    {
        ...
        public static string GenerateFunctionDefinitions()
        {
            ...
            // that don't have a direct reference to StarkPlatform.Compiler.Workspaces.dll
