...
namespace StarkPlatform.Compiler
{
    ...
    public abstract partial class Compilation
    {
        ...
        {
            return CommonCreateArrayTypeSymbol(elementType);
        }

        protected abstract IArrayTypeSymbol CommonCreateArrayTypeSymbol(ITypeSymbol elementType);
            ...
            checked
            {
                ...
                if (!noManifest)
                {
                    if (this.Options.OutputKind.IsApplication())
                    {
                        ...
                        {
                            manifestContents = typeof(Compilation).GetTypeInfo().Assembly.GetManifestResourceStream("StarkPlatform.Compiler.Resources.default.win32manifest");
                        }
                    }
                    else
                    {
