...
namespace StarkPlatform.Compiler
{
    ...
    internal enum WellKnownType
    {
        ...
        core_runtime_DefaultMemberAttribute,
    ...
    internal static class WellKnownTypes
    {
        ...
        private static readonly string[] s_metadataNames = new string[]
        {
            ...
            "core.runtime.DefaultMemberAttribute",
        ...
        private static void AssertEnumAndTableInSync()
        {
            ...
            Debug.Assert((int)WellKnownType.ExtSentinel == 217, $"Unexpected WellKnownType.ExtSentinel {(int)WellKnownType.ExtSentinel}");
