...
using StarkPlatform.Compiler.FlowAnalysis;
...
namespace StarkPlatform.Compiler.Diagnostics
{
    ...
    public abstract class CompilationStartAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.Compilation"/> that is the subject of the analysis.
        /// </summary>
        ...
        /// A compilation end action reports <see cref="Diagnostic"/>s about the <see cref="Compiler.Compilation"/>.
        /// </summary>
        /// <param name="action">Action to be executed at compilation end.</param>
    ...
    /// A compilation action or compilation end action can use a <see cref="CompilationAnalysisContext"/> to report <see cref="Diagnostic"/>s about a <see cref="Compiler.Compilation"/>.
    /// </summary>
    public struct CompilationAnalysisContext
    {
        ...
        /// <summary>
        /// Report a <see cref="Diagnostic"/> about a <see cref="Compiler.Compilation"/>.
        /// </summary>
    ...
    /// A semantic model action operates on the <see cref="Compiler.SemanticModel"/> of a code document, and can use a <see cref="SemanticModelAnalysisContext"/> to report <see cref="Diagnostic"/>s about the model.
    /// </summary>
    public struct SemanticModelAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.SemanticModel"/> that is the subject of the analysis.
        /// </summary>
        ...
        /// <summary>
        /// Report a <see cref="Diagnostic"/> about a <see cref="Compiler.SemanticModel"/>.
        /// </summary>
        /// <param name="diagnostic"><see cref="Diagnostic"/> to be reported.</param>
        public void ReportDiagnostic(Diagnostic diagnostic)
        {
    ...
    public struct SymbolAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.Compilation"/> containing the <see cref="ISymbol"/>.
        /// </summary>
        public Compilation Compilation { get { return _compilation; } }
    ...
    public abstract class CodeBlockStartAnalysisContext<TLanguageKindEnum> where TLanguageKindEnum : struct
    {
        ...
        /// <summary>
        /// <see cref="Compiler.SemanticModel"/> that can provide semantic information about the <see cref="SyntaxNode"/>s in the code block.
        /// </summary>
        public SemanticModel SemanticModel { get { return _semanticModel; } }
    ...
    public abstract class OperationBlockStartAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.Compilation"/> containing the <see cref="OperationBlocks"/>.
        /// </summary>
    ...
    public struct SyntaxNodeAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.SemanticModel"/> that can provide semantic information about the <see cref="SyntaxNode"/>.
        /// </summary>
        public SemanticModel SemanticModel => _semanticModel;

        /// <summary>
        /// <see cref="Compiler.Compilation"/> containing the <see cref="SyntaxNode"/>.
        /// </summary>
    ...
    public struct OperationAnalysisContext
    {
        ...
        /// <summary>
        /// <see cref="Compiler.Compilation"/> containing the <see cref="IOperation"/>.
        /// </summary>
        public Compilation Compilation => _compilation;
