...
{
    [ExportLanguageService(typeof(SyntaxGenerator), LanguageNames.Stark), Shared]
    internal class CSharpSyntaxGenerator : SyntaxGenerator
    {
        ...
        private SyntaxList<ImportDirectiveSyntax> AsUsingDirectives(IEnumerable<SyntaxNode> declarations)
        {
            return declarations != null
                ? SyntaxFactory.List(declarations.Select(this.AsUsingDirective).OfType<ImportDirectiveSyntax>())
                : default;
        }
        ...
        private SyntaxNode AsUsingDirective(SyntaxNode node)
        {
            ...
            return node as ImportDirectiveSyntax;
        }
        ...
        {
            return SyntaxFactory.ImportDirective((NameSyntax)name, SyntaxFactory.Token(SyntaxKind.EndOfLineTrivia));
        }

        public override SyntaxNode AliasImportDeclaration(string aliasIdentifierName, SyntaxNode name)
            => SyntaxFactory.ImportDirective(SyntaxFactory.NameEquals(aliasIdentifierName), (NameSyntax)name);
            ...
            SyntaxNode initializer)
        {
            return SyntaxFactory.FieldDeclaration(
                ...
                SyntaxFactory.VariableDeclaration(
                            ...
                            (TypeSyntax)type,
                            initializer != null ? SyntaxFactory.EqualsValueClause((ExpressionSyntax)initializer) : null), SyntaxFactory.Token(SyntaxKind.EndOfLineTrivia));
        }
        ...
        public override SyntaxNode OperatorDeclaration(OperatorKind kind, IEnumerable<SyntaxNode> parameters = null, SyntaxNode returnType = null, Accessibility accessibility = Accessibility.NotApplicable, DeclarationModifiers modifiers = default, IEnumerable<SyntaxNode> statements = null)
        {
            ...
            var attributes = default(SyntaxList<AttributeSyntax>);
            ...
            SyntaxKind kind, Accessibility accessibility, IEnumerable<SyntaxNode> statements)
        {
            ...
            accessor = statements == null
                ? accessor.WithEosToken(SyntaxFactory.Token(SyntaxKind.EndOfLineTrivia))
        ...
        private static AccessorDeclarationSyntax AccessorDeclaration(SyntaxKind kind, IEnumerable<SyntaxNode> statements)
        {
            ...
            if (statements == null)
            {
                ad = ad.WithEosToken(SyntaxFactory.Token(SyntaxKind.EndOfLineTrivia));
            }
        ...
        private static SyntaxNode WithBodies(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.MethodDeclaration:
                    var method = (MethodDeclarationSyntax)declaration;
                    return method.Body == null ? method.WithEosToken(default).WithBody(CreateBlock(null)) : method;
                case SyntaxKind.OperatorDeclaration:
                    var op = (OperatorDeclarationSyntax)declaration;
                    return op.Body == null ? op.WithEosToken(default).WithBody(CreateBlock(null)) : op;
                case SyntaxKind.ConversionOperatorDeclaration:
                    var cop = (ConversionOperatorDeclarationSyntax)declaration;
                    return cop.Body == null ? cop.WithEosToken(default).WithBody(CreateBlock(null)) : cop;
                case SyntaxKind.PropertyDeclaration:
        ...
        private static AccessorDeclarationSyntax WithBody(AccessorDeclarationSyntax accessor)
        {
            ...
            {
                return accessor.WithEosToken(default).WithBody(CreateBlock(null));
            }
            else
            {
                return accessor;
        ...
        {
            return accessor.Body != null ? accessor.WithEosToken(SyntaxFactory.Token(SyntaxKind.EndOfLineTrivia)).WithBody(null) : accessor;
        }
        ...
        {
            return SyntaxFactory.Attribute((NameSyntax)name, AsAttributeArgumentList(attributeArguments));
        }
        ...
        private static SyntaxList<AttributeSyntax> AsAttributeLists(IEnumerable<SyntaxNode> attributes)
        {
            if (attributes != null)
            {
                return SyntaxFactory.List<AttributeSyntax>(attributes.OfType<AttributeSyntax>());
            }
            else
            {
                return default;
        ...
        private static SyntaxList<AttributeSyntax> AsAttributeList(SyntaxNode node)
        {
            return SyntaxFactory.List(SyntaxFactory.SingletonSeparatedList(node));
        }
        ...
        private static bool IsReturnAttribute(AttributeSyntax list)
        {
        ...
        private static IEnumerable<AttributeSyntax> AsReturnAttributes(IEnumerable<SyntaxNode> attributes)
        {
        ...
        private static SyntaxList<AttributeSyntax> AsAssemblyAttributes(IEnumerable<AttributeSyntax> attributes)
        {
        ...
        private static SyntaxList<AttributeSyntax> GetAttributeLists(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.ClassDeclaration:
        ...
        private static SyntaxNode WithAttributeLists(SyntaxNode declaration, SyntaxList<AttributeSyntax> attributeLists)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.ClassDeclaration:
        ...
        {
            SyntaxList<ImportDirectiveSyntax> usingsToInsert = this.AsUsingDirectives(imports);
            ...
            foreach (var declaration in members)
            {
                switch (declaration.Kind())
                {
                    ...
                    case SyntaxKind.VariableDeclaration:
                        ...
                        break;
                    case SyntaxKind.Attribute:
                        var attrList = (AttributeSyntax)declaration;
                        list.Add(attrList);
                        break;
                    default:
                ...
                case SyntaxKind.VariableDeclaration:
                    {
                        ...
                        return ParentIsEventFieldDeclaration(vd) ? DeclarationKind.Event : DeclarationKind.Variable;
                    }

                case SyntaxKind.Attribute:
                    var list = (AttributeSyntax)declaration;
        ...
        public override string GetName(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                ...
                case SyntaxKind.ImportDirective:
                    return ((ImportDirectiveSyntax)declaration).Name.ToString();
                case SyntaxKind.Parameter:
        ...
        private SyntaxNode WithNameInternal(SyntaxNode declaration, string name)
        {
            ...
            switch (declaration.Kind())
            {
                ...
                case SyntaxKind.FieldDeclaration:
                    ...
                    return ReplaceWithTrivia(declaration, fd.Declaration.Identifier, id);
                    break;
                case SyntaxKind.PropertyDeclaration:
                ...
                case SyntaxKind.EventFieldDeclaration:
                    ...
                    return ReplaceWithTrivia(declaration, efd.Declaration.Identifier, id);
                    break;
                case SyntaxKind.EventDeclaration:
                ...
                case SyntaxKind.ImportDirective:
                    return ReplaceWithTrivia(declaration, ((ImportDirectiveSyntax)declaration).Name, this.DottedName(name));
                case SyntaxKind.Parameter:
                ...
                case SyntaxKind.LocalDeclarationStatement:
                    ...
                    return ReplaceWithTrivia(declaration, ld.Declaration.Identifier, id);
                    break;
                case SyntaxKind.TypeParameter:
            ...
            if (declaration != null)
            {
                switch (declaration.Kind())
                {
                    ...
                    case SyntaxKind.Attribute:
                        ...
                        if (attr.Parent != null)
                        {
                            var attrList = (AttributeSyntax)attr.Parent;
                            return attrList.WithTarget(null);
                        }
                        break;
                }
            }
        ...
        private static SyntaxNode WithVariable(SyntaxNode declaration, VariableDeclarationSyntax variable)
        {
            ...
            if (vd != null)
            {
                return WithVariableDeclaration(declaration, variable);
            }
        ...
        private class AddMissingTokensRewriter : CSharpSyntaxRewriter
        {
            ...
            public override SyntaxToken VisitToken(SyntaxToken token)
            {
                ...
                if (!rewrittenToken.IsMissing || !Stark.SyntaxFacts.IsPunctuationOrKeyword(token.Kind()))
                {
        ...
        private static EqualsValueClauseSyntax GetEqualsValue(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.FieldDeclaration:
                    var fd = (FieldDeclarationSyntax)declaration;
                    return fd.Declaration.Initializer;
                    break;
                case SyntaxKind.PropertyDeclaration:
                    var pd = (PropertyDeclarationSyntax)declaration;
                ...
                case SyntaxKind.LocalDeclarationStatement:
                    var ld = (LocalDeclarationStatementSyntax)declaration;
                    return ld.Declaration.Initializer;
                    break;
                case SyntaxKind.VariableDeclaration:
        ...
        private static SyntaxNode WithEqualsValue(SyntaxNode declaration, EqualsValueClauseSyntax eq)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.FieldDeclaration:
                    var fd = (FieldDeclarationSyntax)declaration;
                    return ReplaceWithTrivia(declaration, fd.Declaration, fd.Declaration.WithInitializer(eq));
                    break;
                case SyntaxKind.PropertyDeclaration:
                    var pd = (PropertyDeclarationSyntax)declaration;
                ...
                case SyntaxKind.LocalDeclarationStatement:
                    var ld = (LocalDeclarationStatementSyntax)declaration;
                    return ReplaceWithTrivia(declaration, ld.Declaration, ld.Declaration.WithInitializer(eq));
                    break;
                case SyntaxKind.VariableDeclaration:
        ...
        public override SyntaxNode WithStatements(SyntaxNode declaration, IEnumerable<SyntaxNode> statements)
        {
            ...
            {
                case SyntaxKind.MethodDeclaration:
                    return ((MethodDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.OperatorDeclaration:
                    return ((OperatorDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.ConversionOperatorDeclaration:
                    return ((ConversionOperatorDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.ConstructorDeclaration:
                    return ((ConstructorDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.DestructorDeclaration:
                    return ((DestructorDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.LocalFunctionStatement:
                    return ((LocalFunctionStatementSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                case SyntaxKind.AnonymousMethodExpression:
                ...
                case SyntaxKind.AddAccessorDeclaration:
                case SyntaxKind.RemoveAccessorDeclaration:
                    return ((AccessorDeclarationSyntax)declaration).WithBody(somebody).WithEosToken(semicolon).WithExpressionBody(null);
                default:
                    return declaration;
            }
        }
        ...
        public override SyntaxNode ReplaceNode(SyntaxNode root, SyntaxNode declaration, SyntaxNode newDeclaration)
        {
            ...
            if (root.Span.Contains(declaration.Span))
            {
                ...
                if (fullDecl != declaration && fullDecl.IsKind(newFullDecl.Kind()))
                {
                    ...
                    var newSubDecl = GetSubDeclarations(newFullDecl);
        ...
        private static SyntaxNode GetSubDeclarations(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.FieldDeclaration:
                ...
                case SyntaxKind.LocalDeclarationStatement:
                    return ((LocalDeclarationStatementSyntax)declaration).Declaration;
                case SyntaxKind.VariableDeclaration:
                    return ((VariableDeclarationSyntax)declaration);
                default:
                    return null;
            }
        }
        ...
        public override SyntaxNode NameOfExpression(SyntaxNode expression)
        {
            return this.InvocationExpression(
                this.IdentifierName(Stark.SyntaxFacts.GetText(SyntaxKind.NameOfKeyword)),
                expression);
        }
        ...
        {
            var arrayType = SyntaxFactory.ArrayType(SyntaxFactory.SingletonList(SyntaxFactory.ArrayRankSpecifier()), (TypeSyntax)elementType);
        ...
        {
            return SyntaxFactory.BinaryExpression(SyntaxKind.AsOptExpression, Parenthesize(expression), (TypeSyntax)type);
        }

        public override SyntaxNode CastExpression(SyntaxNode type, SyntaxNode expression)
            => SyntaxFactory.CastExpression(Parenthesize(expression), (TypeSyntax)type).WithAdditionalAnnotations(Simplifier.Annotation);

        public override SyntaxNode ConvertExpression(SyntaxNode type, SyntaxNode expression)
        {
            return SyntaxFactory.CastExpression(Parenthesize(expression), (TypeSyntax)type).WithAdditionalAnnotations(Simplifier.Annotation);
        }
        ...
        public override SyntaxNode TypeExpression(SpecialType specialType)
        {
            switch (specialType)
            {
                ...
                case SpecialType.System_Int16:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.Int16Keyword));
                case SpecialType.System_Int32:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.Int32Keyword));
                case SpecialType.System_Int64:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.Int64Keyword));
                case SpecialType.System_Object:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.ObjectKeyword));
                case SpecialType.System_Int8:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.Int8Keyword));
                case SpecialType.System_Float32:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.Float32Keyword));
                case SpecialType.System_String:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.StringKeyword));
                case SpecialType.System_UInt16:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.UInt16Keyword));
                case SpecialType.System_UInt32:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.UInt32Keyword));
                case SpecialType.System_UInt64:
                    return SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.UInt16Keyword));
        ...
        {
            return SyntaxFactory.ArrayType(SyntaxFactory.SingletonList(SyntaxFactory.ArrayRankSpecifier()), (TypeSyntax)type);
        }
        ...
        {
            return SyntaxFactory.LocalDeclarationStatement(VariableDeclaration(type, name, initializer, isConst));
        }
        ...
        private static VariableDeclarationSyntax VariableDeclaration(SyntaxNode type, SyntaxToken name, SyntaxNode expression, bool isConst)
        {
            return SyntaxFactory.VariableDeclaration(isConst ? SyntaxFactory.Token(SyntaxKind.ConstKeyword) : SyntaxFactory.Token(SyntaxKind.VarKeyword),
                name, null,
        ...
        public override SyntaxNode UsingStatement(SyntaxNode type, string name, SyntaxNode expression, IEnumerable<SyntaxNode> statements)
        {
            return SyntaxFactory.UsingStatement(
                VariableDeclaration(type, name.ToIdentifierToken(), expression, false),
                expression: null,
