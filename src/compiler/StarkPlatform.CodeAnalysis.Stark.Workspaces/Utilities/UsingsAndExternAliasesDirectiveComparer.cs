...
namespace StarkPlatform.CodeAnalysis.Stark.Utilities
{
    internal class UsingsAndExternAliasesDirectiveComparer : IComparer<SyntaxNode>
    {
        ...
        private static UsingKind GetUsingKind(ImportDirectiveSyntax usingDirective, ExternAliasDirectiveSyntax externDirective)
        {
        ...
        public int Compare(SyntaxNode directive1, SyntaxNode directive2)
        {
            ...
            var using1 = directive1 as ImportDirectiveSyntax;
            var using2 = directive2 as ImportDirectiveSyntax;
