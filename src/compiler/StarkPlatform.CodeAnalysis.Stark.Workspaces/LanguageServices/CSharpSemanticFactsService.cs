...
namespace StarkPlatform.CodeAnalysis.Stark
{
    internal class CSharpSemanticFactsService : AbstractSemanticFactsService, ISemanticFactsService
    {
        ...
        private static void AppendAliasNames(SyntaxList<ImportDirectiveSyntax> usings, ImmutableHashSet<string>.Builder builder)
        {
            ...
            SemanticModel semanticModel, SyntaxNode memberDeclaration, CancellationToken cancellationToken)
        {
            ...
            {
                return SpecializedCollections.SingletonEnumerable(semanticModel.GetDeclaredSymbol(field.Declaration, cancellationToken));
            }
