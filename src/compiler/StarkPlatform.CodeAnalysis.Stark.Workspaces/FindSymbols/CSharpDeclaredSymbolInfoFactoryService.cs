...
namespace StarkPlatform.CodeAnalysis.Stark.FindSymbols
{
    ...
    internal class CSharpDeclaredSymbolInfoFactoryService : AbstractDeclaredSymbolInfoFactoryService
    {
        ...
        private void ProcessUsings(List<Dictionary<string, string>> aliasMaps, SyntaxList<ImportDirectiveSyntax> usings)
        {
