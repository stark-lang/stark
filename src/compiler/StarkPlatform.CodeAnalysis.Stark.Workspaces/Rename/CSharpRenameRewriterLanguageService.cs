...
namespace StarkPlatform.CodeAnalysis.Stark.Rename
{
    [ExportLanguageService(typeof(IRenameRewriterLanguageService), LanguageNames.Stark), Shared]
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                else if (renamedSymbol.Kind == SymbolKind.Alias)
                {
                    ...
                    var currentUsing = (ImportDirectiveSyntax)token.Parent.Parent.Parent;
