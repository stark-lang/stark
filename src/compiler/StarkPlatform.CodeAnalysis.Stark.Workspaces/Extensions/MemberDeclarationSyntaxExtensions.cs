...
namespace StarkPlatform.CodeAnalysis.Stark.Extensions
{
    internal static partial class MemberDeclarationSyntaxExtensions
    {
            ...
            if (member != null)
            {
                switch (member.Kind())
                {
                    ...
                    case SyntaxKind.FieldDeclaration:
                        return ((FieldDeclarationSyntax)member).Declaration.Identifier;
                    case SyntaxKind.EventFieldDeclaration:
                        return ((EventFieldDeclarationSyntax)member).Declaration.Identifier;
        ...
        public static MemberDeclarationSyntax AddAttributeLists(
            this MemberDeclarationSyntax member,
            params AttributeSyntax[] attributeLists)
        {
