...
using SyntaxNodeOrTokenExtensions = StarkPlatform.CodeAnalysis.Shared.Extensions.SyntaxNodeOrTokenExtensions;
...
namespace StarkPlatform.CodeAnalysis.Stark.Extensions
{
    internal static partial class SyntaxNodeExtensions
    {
        ...
        /// top down order.  
        /// </summary>
        public static IEnumerable<ImportDirectiveSyntax> GetEnclosingUsingDirectives(this SyntaxNode node)
        {
        ...
        public static bool CheckTopLevel(this SyntaxNode node, TextSpan span)
        {
            switch (node)
            {
                ...
                case FieldDeclarationSyntax field:
                    {
                        if (field.Declaration.Initializer != null && field.Declaration.Initializer.Span.Contains(span))
                        {
                            return true;
                        }
                        break;
