...
{
    internal static class ImportDirectiveSyntaxExtensions
    {
        public static void SortUsingDirectives(
            this List<ImportDirectiveSyntax> usingDirectives,
            SyntaxList<ImportDirectiveSyntax> existingDirectives,
