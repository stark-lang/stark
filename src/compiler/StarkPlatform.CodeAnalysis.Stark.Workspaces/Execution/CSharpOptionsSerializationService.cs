...
namespace StarkPlatform.CodeAnalysis.Stark.Execution
{
    [ExportLanguageService(typeof(IOptionsSerializationService), LanguageNames.Stark), Shared]
    internal class CSharpOptionsSerializationService : AbstractOptionsSerializationService
    {
        ...
        {
            WriteOptionSetTo(options, LanguageNames.Stark, writer, cancellationToken);
        ...
        public override OptionSet ReadOptionSetFrom(ObjectReader reader, CancellationToken cancellationToken)
        {
            ...
            options = ReadOptionSetFrom(options, LanguageNames.Stark, reader, cancellationToken);
