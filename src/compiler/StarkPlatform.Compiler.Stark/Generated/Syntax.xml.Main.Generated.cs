...
namespace StarkPlatform.Compiler.Stark
{
  ...
  public static partial class SyntaxFactory
  {
    ...
    public static IdentifierNameSyntax IdentifierName(SyntaxToken identifier)
    {
      ...
      return (IdentifierNameSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IdentifierName((Syntax.InternalSyntax.SyntaxToken)identifier.Node).CreateRed();
    }
    ...
    public static QualifiedNameSyntax QualifiedName(NameSyntax left, SyntaxToken dotToken, SimpleNameSyntax right)
    {
      ...
      return (QualifiedNameSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.QualifiedName(left == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameSyntax)left.Green, (Syntax.InternalSyntax.SyntaxToken)dotToken.Node, right == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SimpleNameSyntax)right.Green).CreateRed();
    }
    ...
    public static GenericNameSyntax GenericName(SyntaxToken identifier, TypeArgumentListSyntax typeArgumentList)
    {
      ...
      return (GenericNameSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.GenericName((Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeArgumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeArgumentListSyntax)typeArgumentList.Green).CreateRed();
    }
    ...
    public static TypeArgumentListSyntax TypeArgumentList(SyntaxToken lessThanToken, SeparatedSyntaxList<TypeSyntax> arguments, SyntaxToken greaterThanToken)
    {
      ...
      return (TypeArgumentListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeArgumentList((Syntax.InternalSyntax.SyntaxToken)lessThanToken.Node, arguments.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)greaterThanToken.Node).CreateRed();
    }
    ...
    public static AliasQualifiedNameSyntax AliasQualifiedName(IdentifierNameSyntax alias, SyntaxToken colonColonToken, SimpleNameSyntax name)
    {
      ...
      return (AliasQualifiedNameSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AliasQualifiedName(alias == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.IdentifierNameSyntax)alias.Green, (Syntax.InternalSyntax.SyntaxToken)colonColonToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SimpleNameSyntax)name.Green).CreateRed();
    }
    ...
    public static ConstLiteralTypeSyntax ConstLiteralType(LiteralExpressionSyntax value)
    {
      ...
      return (ConstLiteralTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConstLiteralType(value == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.LiteralExpressionSyntax)value.Green).CreateRed();
    }
    ...
    public static PredefinedTypeSyntax PredefinedType(SyntaxToken keyword)
    {
      ...
      return (PredefinedTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PredefinedType((Syntax.InternalSyntax.SyntaxToken)keyword.Node).CreateRed();
    }
    ...
    public static ArrayTypeSyntax ArrayType(SyntaxList<ArrayRankSpecifierSyntax> rankSpecifiers, TypeSyntax elementType)
    {
      ...
      return (ArrayTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ArrayType(rankSpecifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrayRankSpecifierSyntax>(), elementType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)elementType.Green).CreateRed();
    }
    ...
    public static ArrayRankSpecifierSyntax ArrayRankSpecifier(SyntaxToken openBracketToken, ExpressionSyntax sizes, SyntaxToken closeBracketToken)
    {
      ...
      return (ArrayRankSpecifierSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ArrayRankSpecifier((Syntax.InternalSyntax.SyntaxToken)openBracketToken.Node, sizes == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)sizes.Green, (Syntax.InternalSyntax.SyntaxToken)closeBracketToken.Node).CreateRed();
    }
    ...
    public static PointerTypeSyntax PointerType(SyntaxToken asteriskToken, TypeSyntax elementType)
    {
      ...
      if (elementType == null)
        throw new ArgumentNullException(nameof(elementType));
      return (PointerTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PointerType((Syntax.InternalSyntax.SyntaxToken)asteriskToken.Node, elementType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)elementType.Green).CreateRed();
    }
    ...
    public static NullableTypeSyntax NullableType(SyntaxToken questionToken, TypeSyntax elementType)
    {
      ...
      if (elementType == null)
        throw new ArgumentNullException(nameof(elementType));
      return (NullableTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.NullableType((Syntax.InternalSyntax.SyntaxToken)questionToken.Node, elementType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)elementType.Green).CreateRed();
    }
    ...
    public static TupleTypeSyntax TupleType(SyntaxToken openParenToken, SeparatedSyntaxList<TupleElementSyntax> elements, SyntaxToken closeParenToken)
    {
      ...
      return (TupleTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TupleType((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, elements.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TupleElementSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static TupleElementSyntax TupleElement(TypeSyntax type, SyntaxToken identifier)
    {
      ...
      return (TupleElementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TupleElement(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node).CreateRed();
    }
    ...
    public static OmittedTypeArgumentSyntax OmittedTypeArgument(SyntaxToken omittedTypeArgumentToken)
    {
      ...
      return (OmittedTypeArgumentSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.OmittedTypeArgument((Syntax.InternalSyntax.SyntaxToken)omittedTypeArgumentToken.Node).CreateRed();
    }
    ...
    public static SimpleExtendedTypeSyntax SimpleExtendedType(SyntaxTokenList modifiers, TypeSyntax elementType)
    {
      if (elementType == null)
        throw new ArgumentNullException(nameof(elementType));
      return (SimpleExtendedTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SimpleExtendedType(modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), elementType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)elementType.Green).CreateRed();
    }
    ...
    public static RefTypeSyntax RefType(SyntaxToken letKeyword, SyntaxToken refKindKeyword, SyntaxTokenList modifiers, TypeSyntax elementType)
    {
      ...
      if (elementType == null)
        throw new ArgumentNullException(nameof(elementType));
      return (RefTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RefType((Syntax.InternalSyntax.SyntaxToken)letKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)refKindKeyword.Node, modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), elementType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)elementType.Green).CreateRed();
    }
    ...
    public static ParenthesizedExpressionSyntax ParenthesizedExpression(SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken)
    {
      ...
      return (ParenthesizedExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ParenthesizedExpression((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static TupleExpressionSyntax TupleExpression(SyntaxToken openParenToken, SeparatedSyntaxList<ArgumentSyntax> arguments, SyntaxToken closeParenToken)
    {
      ...
      return (TupleExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TupleExpression((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, arguments.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static PrefixUnaryExpressionSyntax PrefixUnaryExpression(SyntaxKind kind, SyntaxToken operatorToken, ExpressionSyntax operand)
    {
      ...
      return (PrefixUnaryExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PrefixUnaryExpression(kind, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, operand == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)operand.Green).CreateRed();
    }
    ...
    public static AwaitExpressionSyntax AwaitExpression(SyntaxToken awaitKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (AwaitExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AwaitExpression((Syntax.InternalSyntax.SyntaxToken)awaitKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static TryExpressionSyntax TryExpression(SyntaxToken tryKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (TryExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TryExpression((Syntax.InternalSyntax.SyntaxToken)tryKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static PostfixUnaryExpressionSyntax PostfixUnaryExpression(SyntaxKind kind, ExpressionSyntax operand, SyntaxToken operatorToken)
    {
      ...
      return (PostfixUnaryExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PostfixUnaryExpression(kind, operand == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)operand.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node).CreateRed();
    }
    ...
    public static MemberAccessExpressionSyntax MemberAccessExpression(SyntaxKind kind, ExpressionSyntax expression, SyntaxToken operatorToken, SimpleNameSyntax name)
    {
      ...
      if (name == null)
        throw new ArgumentNullException(nameof(name));
      return (MemberAccessExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.MemberAccessExpression(kind, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SimpleNameSyntax)name.Green).CreateRed();
    }
    ...
    public static ConditionalAccessExpressionSyntax ConditionalAccessExpression(ExpressionSyntax expression, SyntaxToken operatorToken, ExpressionSyntax whenNotNull)
    {
      ...
      return (ConditionalAccessExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConditionalAccessExpression(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, whenNotNull == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)whenNotNull.Green).CreateRed();
    }
    ...
    public static MemberBindingExpressionSyntax MemberBindingExpression(SyntaxToken operatorToken, SimpleNameSyntax name)
    {
      ...
      if (name == null)
        throw new ArgumentNullException(nameof(name));
      return (MemberBindingExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.MemberBindingExpression((Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SimpleNameSyntax)name.Green).CreateRed();
    }
    ...
    public static ElementBindingExpressionSyntax ElementBindingExpression(BracketedArgumentListSyntax argumentList)
    {
      ...
      return (ElementBindingExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ElementBindingExpression(argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BracketedArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static RangeExpressionSyntax RangeExpression(ExpressionSyntax leftOperand, SyntaxToken operatorToken, ExpressionSyntax rightOperand)
    {
      ...
      return (RangeExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RangeExpression(leftOperand == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)leftOperand.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, rightOperand == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)rightOperand.Green).CreateRed();
    }
    ...
    public static ImplicitElementAccessSyntax ImplicitElementAccess(BracketedArgumentListSyntax argumentList)
    {
      if (argumentList == null)
        throw new ArgumentNullException(nameof(argumentList));
      return (ImplicitElementAccessSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ImplicitElementAccess(argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BracketedArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static BinaryExpressionSyntax BinaryExpression(SyntaxKind kind, ExpressionSyntax left, SyntaxToken operatorToken, ExpressionSyntax right)
    {
      ...
      if (right == null)
        throw new ArgumentNullException(nameof(right));
      return (BinaryExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BinaryExpression(kind, left == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)left.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, right == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)right.Green).CreateRed();
    }
    ...
    public static AssignmentExpressionSyntax AssignmentExpression(SyntaxKind kind, ExpressionSyntax left, SyntaxToken operatorToken, ExpressionSyntax right)
    {
      ...
      if (right == null)
        throw new ArgumentNullException(nameof(right));
      return (AssignmentExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AssignmentExpression(kind, left == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)left.Green, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, right == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)right.Green).CreateRed();
    }
    ...
    public static IfExpressionSyntax IfExpression(SyntaxToken ifKeyword, ExpressionSyntax condition, SyntaxToken thenKeyword, ExpressionSyntax whenTrue, SyntaxToken elseKeyword, ExpressionSyntax whenFalse)
    {
      ...
      return (IfExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IfExpression((Syntax.InternalSyntax.SyntaxToken)ifKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, (Syntax.InternalSyntax.SyntaxToken)thenKeyword.Node, whenTrue == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)whenTrue.Green, (Syntax.InternalSyntax.SyntaxToken)elseKeyword.Node, whenFalse == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)whenFalse.Green).CreateRed();
    }
    ...
    public static ThisExpressionSyntax ThisExpression(SyntaxToken token)
    {
      ...
      return (ThisExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ThisExpression((Syntax.InternalSyntax.SyntaxToken)token.Node).CreateRed();
    }
    ...
    public static BaseExpressionSyntax BaseExpression(SyntaxToken token)
    {
      ...
      return (BaseExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BaseExpression((Syntax.InternalSyntax.SyntaxToken)token.Node).CreateRed();
    }
    ...
    public static LiteralExpressionSyntax LiteralExpression(SyntaxKind kind, SyntaxToken token)
    {
      ...
      return (LiteralExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LiteralExpression(kind, (Syntax.InternalSyntax.SyntaxToken)token.Node).CreateRed();
    }
    ...
    public static MakeRefExpressionSyntax MakeRefExpression(SyntaxToken keyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken)
    {
      ...
      return (MakeRefExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.MakeRefExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static RefTypeExpressionSyntax RefTypeExpression(SyntaxToken keyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken)
    {
      ...
      return (RefTypeExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RefTypeExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static RefValueExpressionSyntax RefValueExpression(SyntaxToken keyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken comma, TypeSyntax type, SyntaxToken closeParenToken)
    {
      ...
      return (RefValueExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RefValueExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)comma.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static CheckedExpressionSyntax CheckedExpression(SyntaxKind kind, SyntaxToken keyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken)
    {
      ...
      return (CheckedExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CheckedExpression(kind, (Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static DefaultExpressionSyntax DefaultExpression(SyntaxToken keyword, SyntaxToken openParenToken, TypeSyntax type, SyntaxToken closeParenToken)
    {
      ...
      return (DefaultExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DefaultExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static TypeOfExpressionSyntax TypeOfExpression(SyntaxToken keyword, SyntaxToken openParenToken, TypeSyntax type, SyntaxToken closeParenToken)
    {
      ...
      return (TypeOfExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeOfExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static SizeOfExpressionSyntax SizeOfExpression(SyntaxToken keyword, SyntaxToken openParenToken, TypeSyntax type, SyntaxToken closeParenToken)
    {
      ...
      return (SizeOfExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SizeOfExpression((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static InvocationExpressionSyntax InvocationExpression(ExpressionSyntax expression, ArgumentListSyntax argumentList)
    {
      ...
      if (argumentList == null)
        throw new ArgumentNullException(nameof(argumentList));
      return (InvocationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InvocationExpression(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static ElementAccessExpressionSyntax ElementAccessExpression(ExpressionSyntax expression, BracketedArgumentListSyntax argumentList)
    {
      ...
      if (argumentList == null)
        throw new ArgumentNullException(nameof(argumentList));
      return (ElementAccessExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ElementAccessExpression(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BracketedArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static ArgumentListSyntax ArgumentList(SyntaxToken openParenToken, SeparatedSyntaxList<ArgumentSyntax> arguments, SyntaxToken closeParenToken)
    {
      ...
      return (ArgumentListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ArgumentList((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, arguments.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static BracketedArgumentListSyntax BracketedArgumentList(SyntaxToken openBracketToken, SeparatedSyntaxList<ArgumentSyntax> arguments, SyntaxToken closeBracketToken)
    {
      ...
      return (BracketedArgumentListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BracketedArgumentList((Syntax.InternalSyntax.SyntaxToken)openBracketToken.Node, arguments.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBracketToken.Node).CreateRed();
    }
    ...
    public static ArgumentSyntax Argument(NameColonSyntax nameColon, SyntaxToken refKindKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (ArgumentSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Argument(nameColon == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameColonSyntax)nameColon.Green, (Syntax.InternalSyntax.SyntaxToken)refKindKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static NameColonSyntax NameColon(IdentifierNameSyntax name, SyntaxToken colonToken)
    {
      ...
      return (NameColonSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.NameColon(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.IdentifierNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static DeclarationExpressionSyntax DeclarationExpression(TypeSyntax type, VariableDesignationSyntax designation)
    {
      ...
      return (DeclarationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DeclarationExpression(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, designation == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDesignationSyntax)designation.Green).CreateRed();
    }
    ...
    public static CastExpressionSyntax CastExpression(ExpressionSyntax expression, SyntaxToken asKeyword, TypeSyntax type)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (CastExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CastExpression(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)asKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static AnonymousMethodExpressionSyntax AnonymousMethodExpression(SyntaxToken asyncKeyword, SyntaxToken delegateKeyword, ParameterListSyntax parameterList, CSharpSyntaxNode body)
    {
      ...
      return (AnonymousMethodExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AnonymousMethodExpression((Syntax.InternalSyntax.SyntaxToken)asyncKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)delegateKeyword.Node, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CSharpSyntaxNode)body.Green).CreateRed();
    }
    ...
    public static SimpleLambdaExpressionSyntax SimpleLambdaExpression(SyntaxToken asyncKeyword, ParameterSyntax parameter, SyntaxToken arrowToken, CSharpSyntaxNode body)
    {
      ...
      if (body == null)
        throw new ArgumentNullException(nameof(body));
      return (SimpleLambdaExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SimpleLambdaExpression((Syntax.InternalSyntax.SyntaxToken)asyncKeyword.Node, parameter == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterSyntax)parameter.Green, (Syntax.InternalSyntax.SyntaxToken)arrowToken.Node, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CSharpSyntaxNode)body.Green).CreateRed();
    }
    ...
    public static RefExpressionSyntax RefExpression(SyntaxToken refKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (RefExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RefExpression((Syntax.InternalSyntax.SyntaxToken)refKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static InitializerExpressionSyntax InitializerExpression(SyntaxKind kind, SyntaxToken openBraceToken, SeparatedSyntaxList<ExpressionSyntax> expressions, SyntaxToken closeBraceToken)
    {
      ...
      return (InitializerExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InitializerExpression(kind, (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, expressions.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static ObjectCreationExpressionSyntax ObjectCreationExpression(SyntaxToken newKeyword, TypeSyntax type, ArgumentListSyntax argumentList, InitializerExpressionSyntax initializer)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (ObjectCreationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ObjectCreationExpression((Syntax.InternalSyntax.SyntaxToken)newKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentListSyntax)argumentList.Green, initializer == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InitializerExpressionSyntax)initializer.Green).CreateRed();
    }
    ...
    public static AnonymousObjectMemberDeclaratorSyntax AnonymousObjectMemberDeclarator(NameEqualsSyntax nameEquals, ExpressionSyntax expression)
    {
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (AnonymousObjectMemberDeclaratorSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AnonymousObjectMemberDeclarator(nameEquals == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameEqualsSyntax)nameEquals.Green, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static AnonymousObjectCreationExpressionSyntax AnonymousObjectCreationExpression(SyntaxToken newKeyword, SyntaxToken openBraceToken, SeparatedSyntaxList<AnonymousObjectMemberDeclaratorSyntax> initializers, SyntaxToken closeBraceToken)
    {
      ...
      return (AnonymousObjectCreationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AnonymousObjectCreationExpression((Syntax.InternalSyntax.SyntaxToken)newKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, initializers.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AnonymousObjectMemberDeclaratorSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static ArrayCreationExpressionSyntax ArrayCreationExpression(SyntaxToken newKeyword, ArrayTypeSyntax type, InitializerExpressionSyntax initializer)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (ArrayCreationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ArrayCreationExpression((Syntax.InternalSyntax.SyntaxToken)newKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrayTypeSyntax)type.Green, initializer == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InitializerExpressionSyntax)initializer.Green).CreateRed();
    }
    ...
    public static StackAllocArrayCreationExpressionSyntax StackAllocArrayCreationExpression(SyntaxToken stackAllocKeyword, TypeSyntax type, InitializerExpressionSyntax initializer)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (StackAllocArrayCreationExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.StackAllocArrayCreationExpression((Syntax.InternalSyntax.SyntaxToken)stackAllocKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, initializer == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InitializerExpressionSyntax)initializer.Green).CreateRed();
    }
    ...
    public static QueryExpressionSyntax QueryExpression(FromClauseSyntax fromClause, QueryBodySyntax body)
    {
      ...
      if (body == null)
        throw new ArgumentNullException(nameof(body));
      return (QueryExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.QueryExpression(fromClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.FromClauseSyntax)fromClause.Green, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.QueryBodySyntax)body.Green).CreateRed();
    }
    ...
    public static QueryBodySyntax QueryBody(SyntaxList<QueryClauseSyntax> clauses, SelectOrGroupClauseSyntax selectOrGroup, QueryContinuationSyntax continuation)
    {
      ...
      return (QueryBodySyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.QueryBody(clauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.QueryClauseSyntax>(), selectOrGroup == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SelectOrGroupClauseSyntax)selectOrGroup.Green, continuation == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.QueryContinuationSyntax)continuation.Green).CreateRed();
    }
    ...
    public static FromClauseSyntax FromClause(SyntaxToken fromKeyword, TypeSyntax type, SyntaxToken identifier, SyntaxToken inKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (FromClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.FromClause((Syntax.InternalSyntax.SyntaxToken)fromKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)inKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static LetClauseSyntax LetClause(SyntaxToken letKeyword, SyntaxToken identifier, SyntaxToken equalsToken, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (LetClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LetClause((Syntax.InternalSyntax.SyntaxToken)letKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)equalsToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static JoinClauseSyntax JoinClause(SyntaxToken joinKeyword, TypeSyntax type, SyntaxToken identifier, SyntaxToken inKeyword, ExpressionSyntax inExpression, SyntaxToken onKeyword, ExpressionSyntax leftExpression, SyntaxToken equalsKeyword, ExpressionSyntax rightExpression, JoinIntoClauseSyntax into)
    {
      ...
      return (JoinClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.JoinClause((Syntax.InternalSyntax.SyntaxToken)joinKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)inKeyword.Node, inExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)inExpression.Green, (Syntax.InternalSyntax.SyntaxToken)onKeyword.Node, leftExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)leftExpression.Green, (Syntax.InternalSyntax.SyntaxToken)equalsKeyword.Node, rightExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)rightExpression.Green, into == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.JoinIntoClauseSyntax)into.Green).CreateRed();
    }
    ...
    public static JoinIntoClauseSyntax JoinIntoClause(SyntaxToken intoKeyword, SyntaxToken identifier)
    {
      ...
      return (JoinIntoClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.JoinIntoClause((Syntax.InternalSyntax.SyntaxToken)intoKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node).CreateRed();
    }
    ...
    public static WhereClauseSyntax WhereClause(SyntaxToken whereKeyword, ExpressionSyntax condition)
    {
      ...
      if (condition == null)
        throw new ArgumentNullException(nameof(condition));
      return (WhereClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.WhereClause((Syntax.InternalSyntax.SyntaxToken)whereKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green).CreateRed();
    }
    ...
    public static OrderByClauseSyntax OrderByClause(SyntaxToken orderByKeyword, SeparatedSyntaxList<OrderingSyntax> orderings)
    {
      ...
      return (OrderByClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.OrderByClause((Syntax.InternalSyntax.SyntaxToken)orderByKeyword.Node, orderings.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.OrderingSyntax>()).CreateRed();
    }
    ...
    public static OrderingSyntax Ordering(SyntaxKind kind, ExpressionSyntax expression, SyntaxToken ascendingOrDescendingKeyword)
    {
      ...
      return (OrderingSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Ordering(kind, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)ascendingOrDescendingKeyword.Node).CreateRed();
    }
    ...
    public static SelectClauseSyntax SelectClause(SyntaxToken selectKeyword, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (SelectClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SelectClause((Syntax.InternalSyntax.SyntaxToken)selectKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static GroupClauseSyntax GroupClause(SyntaxToken groupKeyword, ExpressionSyntax groupExpression, SyntaxToken byKeyword, ExpressionSyntax byExpression)
    {
      ...
      return (GroupClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.GroupClause((Syntax.InternalSyntax.SyntaxToken)groupKeyword.Node, groupExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)groupExpression.Green, (Syntax.InternalSyntax.SyntaxToken)byKeyword.Node, byExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)byExpression.Green).CreateRed();
    }
    ...
    public static QueryContinuationSyntax QueryContinuation(SyntaxToken intoKeyword, SyntaxToken identifier, QueryBodySyntax body)
    {
      ...
      if (body == null)
        throw new ArgumentNullException(nameof(body));
      return (QueryContinuationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.QueryContinuation((Syntax.InternalSyntax.SyntaxToken)intoKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.QueryBodySyntax)body.Green).CreateRed();
    }
    ...
    public static OmittedArraySizeExpressionSyntax OmittedArraySizeExpression(SyntaxToken omittedArraySizeExpressionToken)
    {
      ...
      return (OmittedArraySizeExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.OmittedArraySizeExpression((Syntax.InternalSyntax.SyntaxToken)omittedArraySizeExpressionToken.Node).CreateRed();
    }
    ...
    public static InterpolatedStringExpressionSyntax InterpolatedStringExpression(SyntaxToken stringStartToken, SyntaxList<InterpolatedStringContentSyntax> contents, SyntaxToken stringEndToken)
    {
      ...
      return (InterpolatedStringExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InterpolatedStringExpression((Syntax.InternalSyntax.SyntaxToken)stringStartToken.Node, contents.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InterpolatedStringContentSyntax>(), (Syntax.InternalSyntax.SyntaxToken)stringEndToken.Node).CreateRed();
    }
    ...
    public static IsPatternExpressionSyntax IsPatternExpression(ExpressionSyntax expression, SyntaxToken isKeyword, PatternSyntax pattern)
    {
      ...
      return (IsPatternExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IsPatternExpression(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)isKeyword.Node, pattern == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PatternSyntax)pattern.Green).CreateRed();
    }
    ...
    public static WhenClauseSyntax WhenClause(SyntaxToken whenKeyword, ExpressionSyntax condition)
    {
      ...
      if (condition == null)
        throw new ArgumentNullException(nameof(condition));
      return (WhenClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.WhenClause((Syntax.InternalSyntax.SyntaxToken)whenKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green).CreateRed();
    }
    ...
    public static DiscardPatternSyntax DiscardPattern(SyntaxToken underscoreToken)
    {
      ...
      return (DiscardPatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DiscardPattern((Syntax.InternalSyntax.SyntaxToken)underscoreToken.Node).CreateRed();
    }
    ...
    public static DeclarationPatternSyntax DeclarationPattern(TypeSyntax type, VariableDesignationSyntax designation)
    {
      ...
      if (designation == null)
        throw new ArgumentNullException(nameof(designation));
      return (DeclarationPatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DeclarationPattern(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, designation == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDesignationSyntax)designation.Green).CreateRed();
    }
    ...
    public static VarPatternSyntax VarPattern(SyntaxToken varKeyword, VariableDesignationSyntax designation)
    {
      ...
      if (designation == null)
        throw new ArgumentNullException(nameof(designation));
      return (VarPatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.VarPattern((Syntax.InternalSyntax.SyntaxToken)varKeyword.Node, designation == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDesignationSyntax)designation.Green).CreateRed();
    }
    ...
    {
      return (RecursivePatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RecursivePattern(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, positionalPatternClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PositionalPatternClauseSyntax)positionalPatternClause.Green, propertyPatternClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PropertyPatternClauseSyntax)propertyPatternClause.Green, designation == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDesignationSyntax)designation.Green).CreateRed();
    }
    ...
    public static PositionalPatternClauseSyntax PositionalPatternClause(SyntaxToken openParenToken, SeparatedSyntaxList<SubpatternSyntax> subpatterns, SyntaxToken closeParenToken)
    {
      ...
      return (PositionalPatternClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PositionalPatternClause((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, subpatterns.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SubpatternSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static PropertyPatternClauseSyntax PropertyPatternClause(SyntaxToken openBraceToken, SeparatedSyntaxList<SubpatternSyntax> subpatterns, SyntaxToken closeBraceToken)
    {
      ...
      return (PropertyPatternClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PropertyPatternClause((Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, subpatterns.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SubpatternSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static SubpatternSyntax Subpattern(NameColonSyntax nameColon, PatternSyntax pattern)
    {
      if (pattern == null)
        throw new ArgumentNullException(nameof(pattern));
      return (SubpatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Subpattern(nameColon == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameColonSyntax)nameColon.Green, pattern == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PatternSyntax)pattern.Green).CreateRed();
    }
    ...
    public static ConstantPatternSyntax ConstantPattern(ExpressionSyntax expression)
    {
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (ConstantPatternSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConstantPattern(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static InterpolatedStringTextSyntax InterpolatedStringText(SyntaxToken textToken)
    {
      ...
      return (InterpolatedStringTextSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InterpolatedStringText((Syntax.InternalSyntax.SyntaxToken)textToken.Node).CreateRed();
    }
    ...
    public static InterpolationSyntax Interpolation(SyntaxToken openBraceToken, ExpressionSyntax expression, InterpolationAlignmentClauseSyntax alignmentClause, InterpolationFormatClauseSyntax formatClause, SyntaxToken closeBraceToken)
    {
      ...
      return (InterpolationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Interpolation((Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, alignmentClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InterpolationAlignmentClauseSyntax)alignmentClause.Green, formatClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.InterpolationFormatClauseSyntax)formatClause.Green, (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static InterpolationAlignmentClauseSyntax InterpolationAlignmentClause(SyntaxToken commaToken, ExpressionSyntax value)
    {
      if (value == null)
        throw new ArgumentNullException(nameof(value));
      return (InterpolationAlignmentClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InterpolationAlignmentClause((Syntax.InternalSyntax.SyntaxToken)commaToken.Node, value == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)value.Green).CreateRed();
    }
    ...
    public static InterpolationFormatClauseSyntax InterpolationFormatClause(SyntaxToken colonToken, SyntaxToken formatStringToken)
    {
      ...
      return (InterpolationFormatClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InterpolationFormatClause((Syntax.InternalSyntax.SyntaxToken)colonToken.Node, (Syntax.InternalSyntax.SyntaxToken)formatStringToken.Node).CreateRed();
    }
    ...
    public static GlobalStatementSyntax GlobalStatement(StatementSyntax statement)
    {
      ...
      return (GlobalStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.GlobalStatement(statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static BlockSyntax Block(SyntaxToken openBraceToken, SyntaxList<StatementSyntax> statements, SyntaxToken closeBraceToken)
    {
      ...
      return (BlockSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Block((Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, statements.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static LocalFunctionStatementSyntax LocalFunctionStatement(SyntaxTokenList modifiers, TypeSyntax returnType, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ParameterListSyntax parameterList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      ...
      return (LocalFunctionStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LocalFunctionStatement(modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), returnType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)returnType.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)body.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static LocalDeclarationStatementSyntax LocalDeclarationStatement(SyntaxToken awaitKeyword, SyntaxToken usingKeyword, VariableDeclarationSyntax declaration, SyntaxToken eosToken)
    {
      ...
      return (LocalDeclarationStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LocalDeclarationStatement((Syntax.InternalSyntax.SyntaxToken)awaitKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)usingKeyword.Node, declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDeclarationSyntax)declaration.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static VariableDeclarationSyntax VariableDeclaration(SyntaxToken variableKeyword, SyntaxToken identifier, SyntaxToken colonToken, TypeSyntax type, EqualsValueClauseSyntax initializer)
    {
      ...
      return (VariableDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.VariableDeclaration((Syntax.InternalSyntax.SyntaxToken)variableKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, initializer == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.EqualsValueClauseSyntax)initializer.Green).CreateRed();
    }
    ...
    public static EqualsValueClauseSyntax EqualsValueClause(SyntaxToken equalsToken, ExpressionSyntax value)
    {
      ...
      if (value == null)
        throw new ArgumentNullException(nameof(value));
      return (EqualsValueClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EqualsValueClause((Syntax.InternalSyntax.SyntaxToken)equalsToken.Node, value == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)value.Green).CreateRed();
    }
    ...
    public static SingleVariableDesignationSyntax SingleVariableDesignation(SyntaxToken identifier)
    {
      ...
      return (SingleVariableDesignationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SingleVariableDesignation((Syntax.InternalSyntax.SyntaxToken)identifier.Node).CreateRed();
    }
    ...
    public static DiscardDesignationSyntax DiscardDesignation(SyntaxToken underscoreToken)
    {
      ...
      return (DiscardDesignationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DiscardDesignation((Syntax.InternalSyntax.SyntaxToken)underscoreToken.Node).CreateRed();
    }
    ...
    public static ParenthesizedVariableDesignationSyntax ParenthesizedVariableDesignation(SyntaxToken openParenToken, SeparatedSyntaxList<VariableDesignationSyntax> variables, SyntaxToken closeParenToken)
    {
      ...
      return (ParenthesizedVariableDesignationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ParenthesizedVariableDesignation((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, variables.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDesignationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static ExpressionStatementSyntax ExpressionStatement(ExpressionSyntax expression, SyntaxToken eosToken)
    {
      ...
      return (ExpressionStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ExpressionStatement(expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static EmptyStatementSyntax EmptyStatement(SyntaxToken eosToken)
    {
      ...
      return (EmptyStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EmptyStatement((Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static LabeledStatementSyntax LabeledStatement(SyntaxToken identifier, SyntaxToken colonToken, StatementSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (LabeledStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LabeledStatement((Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static GotoStatementSyntax GotoStatement(SyntaxKind kind, SyntaxToken gotoKeyword, SyntaxToken caseOrDefaultKeyword, ExpressionSyntax expression, SyntaxToken eosToken)
    {
      ...
      return (GotoStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.GotoStatement(kind, (Syntax.InternalSyntax.SyntaxToken)gotoKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)caseOrDefaultKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static BreakStatementSyntax BreakStatement(SyntaxToken breakKeyword, SyntaxToken eosToken)
    {
      ...
      return (BreakStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BreakStatement((Syntax.InternalSyntax.SyntaxToken)breakKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ContinueStatementSyntax ContinueStatement(SyntaxToken continueKeyword, SyntaxToken eosToken)
    {
      ...
      return (ContinueStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ContinueStatement((Syntax.InternalSyntax.SyntaxToken)continueKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ReturnStatementSyntax ReturnStatement(SyntaxToken returnKeyword, ExpressionSyntax expression, SyntaxToken eosToken)
    {
      ...
      return (ReturnStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ReturnStatement((Syntax.InternalSyntax.SyntaxToken)returnKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ThrowStatementSyntax ThrowStatement(SyntaxToken throwKeyword, ExpressionSyntax expression, SyntaxToken eosToken)
    {
      ...
      return (ThrowStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ThrowStatement((Syntax.InternalSyntax.SyntaxToken)throwKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static YieldStatementSyntax YieldStatement(SyntaxKind kind, SyntaxToken yieldKeyword, SyntaxToken returnOrBreakKeyword, ExpressionSyntax expression, SyntaxToken eosToken)
    {
      ...
      return (YieldStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.YieldStatement(kind, (Syntax.InternalSyntax.SyntaxToken)yieldKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)returnOrBreakKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static WhileStatementSyntax WhileStatement(SyntaxToken whileKeyword, ExpressionSyntax condition, BlockSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (WhileStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.WhileStatement((Syntax.InternalSyntax.SyntaxToken)whileKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)statement.Green).CreateRed();
    }
    ...
    public static DoStatementSyntax DoStatement(SyntaxToken doKeyword, BlockSyntax statement, SyntaxToken whileKeyword, ExpressionSyntax condition, SyntaxToken eosToken)
    {
      ...
      return (DoStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DoStatement((Syntax.InternalSyntax.SyntaxToken)doKeyword.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)statement.Green, (Syntax.InternalSyntax.SyntaxToken)whileKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ForStatementSyntax ForStatement(SyntaxToken awaitKeyword, SyntaxToken forEachKeyword, ExpressionSyntax variable, SyntaxToken inKeyword, ExpressionSyntax expression, BlockSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (ForStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ForStatement((Syntax.InternalSyntax.SyntaxToken)awaitKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)forEachKeyword.Node, variable == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)variable.Green, (Syntax.InternalSyntax.SyntaxToken)inKeyword.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)statement.Green).CreateRed();
    }
    ...
    public static UsingStatementSyntax UsingStatement(SyntaxToken awaitKeyword, SyntaxToken usingKeyword, SyntaxToken openParenToken, VariableDeclarationSyntax declaration, ExpressionSyntax expression, SyntaxToken closeParenToken, StatementSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (UsingStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.UsingStatement((Syntax.InternalSyntax.SyntaxToken)awaitKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)usingKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDeclarationSyntax)declaration.Green, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static InlineILStatementSyntax InlineILStatement(SyntaxTokenList instruction, ExpressionSyntax argument, SyntaxToken eosToken)
    {
      ...
      return (InlineILStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InlineILStatement(instruction.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), argument == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)argument.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static FixedStatementSyntax FixedStatement(SyntaxToken fixedKeyword, SyntaxToken openParenToken, VariableDeclarationSyntax declaration, SyntaxToken closeParenToken, StatementSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (FixedStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.FixedStatement((Syntax.InternalSyntax.SyntaxToken)fixedKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDeclarationSyntax)declaration.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static CheckedStatementSyntax CheckedStatement(SyntaxKind kind, SyntaxToken keyword, BlockSyntax block)
    {
      ...
      return (CheckedStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CheckedStatement(kind, (Syntax.InternalSyntax.SyntaxToken)keyword.Node, block == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)block.Green).CreateRed();
    }
    ...
    public static UnsafeStatementSyntax UnsafeStatement(SyntaxToken unsafeKeyword, SyntaxToken ilKeyword, BlockSyntax block)
    {
      ...
      if (block == null)
        throw new ArgumentNullException(nameof(block));
      return (UnsafeStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.UnsafeStatement((Syntax.InternalSyntax.SyntaxToken)unsafeKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)ilKeyword.Node, block == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)block.Green).CreateRed();
    }
    ...
    public static LockStatementSyntax LockStatement(SyntaxToken lockKeyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken, StatementSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (LockStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LockStatement((Syntax.InternalSyntax.SyntaxToken)lockKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static IfStatementSyntax IfStatement(SyntaxToken ifKeyword, ExpressionSyntax condition, SyntaxToken thenKeyword, BlockSyntax statement, ElseClauseSyntax @else)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (IfStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IfStatement((Syntax.InternalSyntax.SyntaxToken)ifKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, (Syntax.InternalSyntax.SyntaxToken)thenKeyword.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)statement.Green, @else == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ElseClauseSyntax)@else.Green).CreateRed();
    }
    ...
    public static ElseClauseSyntax ElseClause(SyntaxToken elseKeyword, StatementSyntax statement)
    {
      ...
      if (statement == null)
        throw new ArgumentNullException(nameof(statement));
      return (ElseClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ElseClause((Syntax.InternalSyntax.SyntaxToken)elseKeyword.Node, statement == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax)statement.Green).CreateRed();
    }
    ...
    public static SwitchStatementSyntax SwitchStatement(SyntaxToken switchKeyword, SyntaxToken openParenToken, ExpressionSyntax expression, SyntaxToken closeParenToken, SyntaxToken openBraceToken, SyntaxList<SwitchSectionSyntax> sections, SyntaxToken closeBraceToken)
    {
      ...
      return (SwitchStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SwitchStatement((Syntax.InternalSyntax.SyntaxToken)switchKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node, (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, sections.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SwitchSectionSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    {
      return (SwitchSectionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SwitchSection(labels.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SwitchLabelSyntax>(), statements.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.StatementSyntax>()).CreateRed();
    }
    ...
    public static CasePatternSwitchLabelSyntax CasePatternSwitchLabel(SyntaxToken keyword, PatternSyntax pattern, WhenClauseSyntax whenClause, SyntaxToken colonToken)
    {
      ...
      if (pattern == null)
        throw new ArgumentNullException(nameof(pattern));
      return (CasePatternSwitchLabelSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CasePatternSwitchLabel((Syntax.InternalSyntax.SyntaxToken)keyword.Node, pattern == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PatternSyntax)pattern.Green, whenClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.WhenClauseSyntax)whenClause.Green, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static CaseSwitchLabelSyntax CaseSwitchLabel(SyntaxToken keyword, ExpressionSyntax value, SyntaxToken colonToken)
    {
      ...
      if (value == null)
        throw new ArgumentNullException(nameof(value));
      return (CaseSwitchLabelSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CaseSwitchLabel((Syntax.InternalSyntax.SyntaxToken)keyword.Node, value == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)value.Green, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static DefaultSwitchLabelSyntax DefaultSwitchLabel(SyntaxToken keyword, SyntaxToken colonToken)
    {
      ...
      return (DefaultSwitchLabelSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DefaultSwitchLabel((Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static SwitchExpressionSyntax SwitchExpression(ExpressionSyntax governingExpression, SyntaxToken switchKeyword, SyntaxToken openBraceToken, SeparatedSyntaxList<SwitchExpressionArmSyntax> arms, SyntaxToken closeBraceToken)
    {
      ...
      return (SwitchExpressionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SwitchExpression(governingExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)governingExpression.Green, (Syntax.InternalSyntax.SyntaxToken)switchKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, arms.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SwitchExpressionArmSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static SwitchExpressionArmSyntax SwitchExpressionArm(PatternSyntax pattern, WhenClauseSyntax whenClause, SyntaxToken equalsGreaterThanToken, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (SwitchExpressionArmSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SwitchExpressionArm(pattern == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.PatternSyntax)pattern.Green, whenClause == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.WhenClauseSyntax)whenClause.Green, (Syntax.InternalSyntax.SyntaxToken)equalsGreaterThanToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static TryStatementSyntax TryStatement(SyntaxToken tryKeyword, BlockSyntax block, SyntaxList<CatchClauseSyntax> catches, FinallyClauseSyntax @finally)
    {
      ...
      if (block == null)
        throw new ArgumentNullException(nameof(block));
      return (TryStatementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TryStatement((Syntax.InternalSyntax.SyntaxToken)tryKeyword.Node, block == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)block.Green, catches.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CatchClauseSyntax>(), @finally == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.FinallyClauseSyntax)@finally.Green).CreateRed();
    }
    ...
    public static CatchClauseSyntax CatchClause(SyntaxToken catchKeyword, CatchDeclarationSyntax declaration, CatchFilterClauseSyntax filter, BlockSyntax block)
    {
      ...
      if (block == null)
        throw new ArgumentNullException(nameof(block));
      return (CatchClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CatchClause((Syntax.InternalSyntax.SyntaxToken)catchKeyword.Node, declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CatchDeclarationSyntax)declaration.Green, filter == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CatchFilterClauseSyntax)filter.Green, block == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)block.Green).CreateRed();
    }
    ...
    public static CatchFilterClauseSyntax CatchFilterClause(SyntaxToken whenKeyword, SyntaxToken openParenToken, ExpressionSyntax filterExpression, SyntaxToken closeParenToken)
    {
      ...
      return (CatchFilterClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CatchFilterClause((Syntax.InternalSyntax.SyntaxToken)whenKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, filterExpression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)filterExpression.Green, (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static FinallyClauseSyntax FinallyClause(SyntaxToken finallyKeyword, BlockSyntax block)
    {
      ...
      if (block == null)
        throw new ArgumentNullException(nameof(block));
      return (FinallyClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.FinallyClause((Syntax.InternalSyntax.SyntaxToken)finallyKeyword.Node, block == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)block.Green).CreateRed();
    }
    ...
    public static CompilationUnitSyntax CompilationUnit(SyntaxList<ExternAliasDirectiveSyntax> externs, SyntaxList<ImportDirectiveSyntax> usings, SyntaxList<AttributeSyntax> attributeLists, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken endOfFileToken)
    {
      ...
      return (CompilationUnitSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CompilationUnit(externs.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExternAliasDirectiveSyntax>(), usings.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImportDirectiveSyntax>(), attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)endOfFileToken.Node).CreateRed();
    }
    ...
    public static ExternAliasDirectiveSyntax ExternAliasDirective(SyntaxToken externKeyword, SyntaxToken aliasKeyword, SyntaxToken identifier, SyntaxToken eosToken)
    {
      ...
      return (ExternAliasDirectiveSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ExternAliasDirective((Syntax.InternalSyntax.SyntaxToken)externKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)aliasKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ImportDirectiveSyntax ImportDirective(SyntaxToken importKeyword, SyntaxToken staticKeyword, NameEqualsSyntax alias, NameSyntax name, SyntaxToken eosToken)
    {
      ...
      return (ImportDirectiveSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ImportDirective((Syntax.InternalSyntax.SyntaxToken)importKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)staticKeyword.Node, alias == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameEqualsSyntax)alias.Green, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static AttributeTargetSpecifierSyntax AttributeTargetSpecifier(SyntaxToken identifier, SyntaxToken colonToken)
    {
      ...
      return (AttributeTargetSpecifierSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AttributeTargetSpecifier((Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static AttributeSyntax Attribute(SyntaxToken atToken, AttributeTargetSpecifierSyntax target, NameSyntax name, AttributeArgumentListSyntax argumentList)
    {
      ...
      if (name == null)
        throw new ArgumentNullException(nameof(name));
      return (AttributeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Attribute((Syntax.InternalSyntax.SyntaxToken)atToken.Node, target == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeTargetSpecifierSyntax)target.Green, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameSyntax)name.Green, argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static AttributeArgumentListSyntax AttributeArgumentList(SyntaxToken openParenToken, SeparatedSyntaxList<AttributeArgumentSyntax> arguments, SyntaxToken closeParenToken)
    {
      ...
      return (AttributeArgumentListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AttributeArgumentList((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, arguments.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeArgumentSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static AttributeArgumentSyntax AttributeArgument(NameEqualsSyntax nameEquals, NameColonSyntax nameColon, ExpressionSyntax expression)
    {
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (AttributeArgumentSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AttributeArgument(nameEquals == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameEqualsSyntax)nameEquals.Green, nameColon == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameColonSyntax)nameColon.Green, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static NameEqualsSyntax NameEquals(IdentifierNameSyntax name, SyntaxToken equalsToken)
    {
      ...
      return (NameEqualsSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.NameEquals(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.IdentifierNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)equalsToken.Node).CreateRed();
    }
    ...
    public static TypeParameterListSyntax TypeParameterList(SyntaxToken lessThanToken, SeparatedSyntaxList<TypeParameterSyntax> parameters, SyntaxToken greaterThanToken)
    {
      ...
      return (TypeParameterListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeParameterList((Syntax.InternalSyntax.SyntaxToken)lessThanToken.Node, parameters.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterSyntax>(), (Syntax.InternalSyntax.SyntaxToken)greaterThanToken.Node).CreateRed();
    }
    ...
    public static TypeParameterSyntax TypeParameter(SyntaxList<AttributeSyntax> attributeLists, SyntaxToken varianceKeyword, SyntaxToken identifier)
    {
      ...
      return (TypeParameterSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeParameter(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)varianceKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node).CreateRed();
    }
    ...
    public static ModuleDeclarationSyntax ModuleDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken keyword, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ExtendListSyntax extendList, ImplementListSyntax implementList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken openBraceToken, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken eosToken)
    {
      ...
      return (ModuleDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ModuleDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, extendList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExtendListSyntax)extendList.Green, implementList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImplementListSyntax)implementList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ClassDeclarationSyntax ClassDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken keyword, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ExtendListSyntax extendList, ImplementListSyntax implementList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken openBraceToken, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken eosToken)
    {
      ...
      return (ClassDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ClassDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, extendList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExtendListSyntax)extendList.Green, implementList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImplementListSyntax)implementList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static StructDeclarationSyntax StructDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken keyword, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ExtendListSyntax extendList, ImplementListSyntax implementList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken openBraceToken, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken eosToken)
    {
      ...
      return (StructDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.StructDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, extendList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExtendListSyntax)extendList.Green, implementList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImplementListSyntax)implementList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static InterfaceDeclarationSyntax InterfaceDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken keyword, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ExtendListSyntax extendList, ImplementListSyntax implementList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken openBraceToken, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken eosToken)
    {
      ...
      return (InterfaceDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.InterfaceDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)keyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, extendList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExtendListSyntax)extendList.Green, implementList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImplementListSyntax)implementList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static EnumDeclarationSyntax EnumDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken enumKeyword, SyntaxToken identifier, ExtendListSyntax extendList, ImplementListSyntax implementList, SyntaxToken openBraceToken, SyntaxList<EnumMemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken eosToken)
    {
      ...
      return (EnumDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EnumDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)enumKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, extendList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExtendListSyntax)extendList.Green, implementList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ImplementListSyntax)implementList.Green, (Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, members.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.EnumMemberDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static DelegateDeclarationSyntax DelegateDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken delegateKeyword, TypeSyntax returnType, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ParameterListSyntax parameterList, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxToken eosToken)
    {
      ...
      return (DelegateDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DelegateDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)delegateKeyword.Node, returnType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)returnType.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static EnumMemberDeclarationSyntax EnumMemberDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxToken identifier, EqualsValueClauseSyntax equalsValue)
    {
      ...
      return (EnumMemberDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EnumMemberDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)identifier.Node, equalsValue == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.EqualsValueClauseSyntax)equalsValue.Green).CreateRed();
    }
    ...
    public static ExtendListSyntax ExtendList(SyntaxToken extendsKeyword, SeparatedSyntaxList<BaseTypeSyntax> types)
    {
      ...
      return (ExtendListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ExtendList((Syntax.InternalSyntax.SyntaxToken)extendsKeyword.Node, types.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BaseTypeSyntax>()).CreateRed();
    }
    ...
    public static ImplementListSyntax ImplementList(SyntaxToken implementsKeyword, SeparatedSyntaxList<BaseTypeSyntax> types)
    {
      ...
      return (ImplementListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ImplementList((Syntax.InternalSyntax.SyntaxToken)implementsKeyword.Node, types.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BaseTypeSyntax>()).CreateRed();
    }
    ...
    public static ThrowsListSyntax ThrowsList(SyntaxToken throwsKeyword, SeparatedSyntaxList<TypeSyntax> types)
    {
      ...
      return (ThrowsListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ThrowsList((Syntax.InternalSyntax.SyntaxToken)throwsKeyword.Node, types.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax>()).CreateRed();
    }
    ...
    public static SimpleBaseTypeSyntax SimpleBaseType(TypeSyntax type)
    {
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (SimpleBaseTypeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SimpleBaseType(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static ContractClauseSyntax ContractClause(SyntaxToken contractKeyword, ExpressionSyntax condition)
    {
      ...
      if (condition == null)
        throw new ArgumentNullException(nameof(condition));
      return (ContractClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ContractClause((Syntax.InternalSyntax.SyntaxToken)contractKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green).CreateRed();
    }
    ...
    public static TypeParameterConstraintClauseSyntax TypeParameterConstraintClause(SyntaxToken whereKeyword, IdentifierNameSyntax name, SyntaxToken colonToken, SeparatedSyntaxList<TypeParameterConstraintSyntax> constraints)
    {
      ...
      return (TypeParameterConstraintClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeParameterConstraintClause((Syntax.InternalSyntax.SyntaxToken)whereKeyword.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.IdentifierNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node, constraints.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintSyntax>()).CreateRed();
    }
    ...
    public static ConstConstraintSyntax ConstConstraint(SyntaxToken isKeyword, SyntaxToken constKeyword, TypeSyntax type)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (ConstConstraintSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConstConstraint((Syntax.InternalSyntax.SyntaxToken)isKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)constKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static ExtendsOrImplementsTypeConstraintSyntax ExtendsOrImplementsTypeConstraint(SyntaxKind kind, SyntaxToken extendsOrImplementsKeyword, TypeSyntax type)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (ExtendsOrImplementsTypeConstraintSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ExtendsOrImplementsTypeConstraint(kind, (Syntax.InternalSyntax.SyntaxToken)extendsOrImplementsKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static FieldDeclarationSyntax FieldDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, VariableDeclarationSyntax declaration, SyntaxToken eosToken)
    {
      ...
      return (FieldDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.FieldDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDeclarationSyntax)declaration.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static EventFieldDeclarationSyntax EventFieldDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken eventKeyword, VariableDeclarationSyntax declaration, SyntaxToken eosToken)
    {
      ...
      return (EventFieldDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EventFieldDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)eventKeyword.Node, declaration == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.VariableDeclarationSyntax)declaration.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ExplicitInterfaceSpecifierSyntax ExplicitInterfaceSpecifier(NameSyntax name, SyntaxToken dotToken)
    {
      ...
      return (ExplicitInterfaceSpecifierSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ExplicitInterfaceSpecifier(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.NameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)dotToken.Node).CreateRed();
    }
    ...
    public static MethodDeclarationSyntax MethodDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken funcKeyword, ExplicitInterfaceSpecifierSyntax explicitInterfaceSpecifier, SyntaxToken identifier, TypeParameterListSyntax typeParameterList, ParameterListSyntax parameterList, SyntaxToken returnToken, TypeSyntax returnType, SyntaxList<TypeParameterConstraintClauseSyntax> constraintClauses, SyntaxList<ContractClauseSyntax> contractClauses, ThrowsListSyntax throwsList, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      ...
      return (MethodDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.MethodDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)funcKeyword.Node, explicitInterfaceSpecifier == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExplicitInterfaceSpecifierSyntax)explicitInterfaceSpecifier.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, typeParameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterListSyntax)typeParameterList.Green, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, (Syntax.InternalSyntax.SyntaxToken)returnToken.Node, returnType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)returnType.Green, constraintClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), throwsList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ThrowsListSyntax)throwsList.Green, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)body.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static OperatorDeclarationSyntax OperatorDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken funcKeyword, SyntaxToken operatorKeyword, SyntaxToken operatorToken, ParameterListSyntax parameterList, SyntaxToken returnToken, TypeSyntax returnType, SyntaxList<ContractClauseSyntax> contractClauses, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      switch (funcKeyword.Kind())
      {
        case SyntaxKind.FuncKeyword:
      ...
      return (OperatorDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.OperatorDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)funcKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)operatorKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, (Syntax.InternalSyntax.SyntaxToken)returnToken.Node, returnType == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)returnType.Green, contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)body.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }


    /// <summary>Creates a new OperatorDeclarationSyntax instance.</summary>
    public static OperatorDeclarationSyntax OperatorDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken operatorToken, ParameterListSyntax parameterList, TypeSyntax returnType, SyntaxList<ContractClauseSyntax> contractClauses, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      return SyntaxFactory.OperatorDeclaration(attributeLists, modifiers, SyntaxFactory.Token(SyntaxKind.FuncKeyword), SyntaxFactory.Token(SyntaxKind.OperatorKeyword), operatorToken, parameterList, SyntaxFactory.Token(SyntaxKind.MinusGreaterThanToken), returnType, contractClauses, body, expressionBody, eosToken);
    }

    /// <summary>Creates a new OperatorDeclarationSyntax instance.</summary>
    public static OperatorDeclarationSyntax OperatorDeclaration(SyntaxToken operatorToken, TypeSyntax returnType)
    {
      return SyntaxFactory.OperatorDeclaration(default(SyntaxList<AttributeSyntax>), default(SyntaxTokenList), SyntaxFactory.Token(SyntaxKind.FuncKeyword), SyntaxFactory.Token(SyntaxKind.OperatorKeyword), operatorToken, SyntaxFactory.ParameterList(), SyntaxFactory.Token(SyntaxKind.MinusGreaterThanToken), returnType, default(SyntaxList<ContractClauseSyntax>), default(BlockSyntax), default(ArrowExpressionClauseSyntax), default(SyntaxToken));
    }
    ...
    public static ConstructorInitializerSyntax ConstructorInitializer(SyntaxKind kind, SyntaxToken colonToken, SyntaxToken thisOrBaseKeyword, ArgumentListSyntax argumentList)
    {
      ...
      if (argumentList == null)
        throw new ArgumentNullException(nameof(argumentList));
      return (ConstructorInitializerSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConstructorInitializer(kind, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node, (Syntax.InternalSyntax.SyntaxToken)thisOrBaseKeyword.Node, argumentList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArgumentListSyntax)argumentList.Green).CreateRed();
    }
    ...
    public static DestructorDeclarationSyntax DestructorDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken tildeToken, SyntaxToken identifier, ParameterListSyntax parameterList, SyntaxList<ContractClauseSyntax> contractClauses, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      ...
      return (DestructorDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DestructorDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)tildeToken.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterListSyntax)parameterList.Green, contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)body.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static PropertyDeclarationSyntax PropertyDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken funcKeyword, ExplicitInterfaceSpecifierSyntax explicitInterfaceSpecifier, SyntaxToken identifier, SyntaxToken returnToken, TypeSyntax type, SyntaxList<ContractClauseSyntax> contractClauses, AccessorListSyntax accessorList, ArrowExpressionClauseSyntax expressionBody, EqualsValueClauseSyntax initializer, SyntaxToken eosToken)
    {
      ...
      return (PropertyDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PropertyDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)funcKeyword.Node, explicitInterfaceSpecifier == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExplicitInterfaceSpecifierSyntax)explicitInterfaceSpecifier.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)returnToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), accessorList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AccessorListSyntax)accessorList.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, initializer == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.EqualsValueClauseSyntax)initializer.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ArrowExpressionClauseSyntax ArrowExpressionClause(SyntaxToken arrowToken, ExpressionSyntax expression)
    {
      ...
      if (expression == null)
        throw new ArgumentNullException(nameof(expression));
      return (ArrowExpressionClauseSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ArrowExpressionClause((Syntax.InternalSyntax.SyntaxToken)arrowToken.Node, expression == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)expression.Green).CreateRed();
    }
    ...
    public static EventDeclarationSyntax EventDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken eventKeyword, TypeSyntax type, ExplicitInterfaceSpecifierSyntax explicitInterfaceSpecifier, SyntaxToken identifier, SyntaxList<ContractClauseSyntax> contractClauses, AccessorListSyntax accessorList)
    {
      ...
      return (EventDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EventDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)eventKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, explicitInterfaceSpecifier == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExplicitInterfaceSpecifierSyntax)explicitInterfaceSpecifier.Green, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), accessorList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AccessorListSyntax)accessorList.Green).CreateRed();
    }
    ...
    public static IndexerDeclarationSyntax IndexerDeclaration(SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken funcKeyword, SyntaxToken operatorKeyword, ExplicitInterfaceSpecifierSyntax explicitInterfaceSpecifier, BracketedParameterListSyntax parameterList, SyntaxToken returnToken, TypeSyntax type, SyntaxList<ContractClauseSyntax> contractClauses, AccessorListSyntax accessorList, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      ...
      return (IndexerDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IndexerDeclaration(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)funcKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)operatorKeyword.Node, explicitInterfaceSpecifier == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExplicitInterfaceSpecifierSyntax)explicitInterfaceSpecifier.Green, parameterList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BracketedParameterListSyntax)parameterList.Green, (Syntax.InternalSyntax.SyntaxToken)returnToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, contractClauses.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ContractClauseSyntax>(), accessorList == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AccessorListSyntax)accessorList.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static AccessorListSyntax AccessorList(SyntaxToken openBraceToken, SyntaxList<AccessorDeclarationSyntax> accessors, SyntaxToken closeBraceToken)
    {
      ...
      return (AccessorListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AccessorList((Syntax.InternalSyntax.SyntaxToken)openBraceToken.Node, accessors.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AccessorDeclarationSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBraceToken.Node).CreateRed();
    }
    ...
    public static AccessorDeclarationSyntax AccessorDeclaration(SyntaxKind kind, SyntaxList<AttributeSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken keyword, BlockSyntax body, ArrowExpressionClauseSyntax expressionBody, SyntaxToken eosToken)
    {
      ...
      return (AccessorDeclarationSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.AccessorDeclaration(kind, attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), modifiers.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)keyword.Node, body == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.BlockSyntax)body.Green, expressionBody == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ArrowExpressionClauseSyntax)expressionBody.Green, (Syntax.InternalSyntax.SyntaxToken)eosToken.Node).CreateRed();
    }
    ...
    public static ParameterListSyntax ParameterList(SyntaxToken openParenToken, SeparatedSyntaxList<ParameterSyntax> parameters, SyntaxToken closeParenToken)
    {
      ...
      return (ParameterListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ParameterList((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, parameters.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static BracketedParameterListSyntax BracketedParameterList(SyntaxToken openBracketToken, SeparatedSyntaxList<ParameterSyntax> parameters, SyntaxToken closeBracketToken)
    {
      ...
      return (BracketedParameterListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BracketedParameterList((Syntax.InternalSyntax.SyntaxToken)openBracketToken.Node, parameters.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ParameterSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBracketToken.Node).CreateRed();
    }
    ...
    public static ParameterSyntax Parameter(SyntaxList<AttributeSyntax> attributeLists, SyntaxToken identifier, SyntaxToken colonToken, TypeSyntax type, EqualsValueClauseSyntax @default)
    {
      ...
      return (ParameterSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.Parameter(attributeLists.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.AttributeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, @default == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.EqualsValueClauseSyntax)@default.Green).CreateRed();
    }
    ...
    {
      return (SkippedTokensTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.SkippedTokensTrivia(tokens.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>()).CreateRed();
    }
    ...
    public static DocumentationCommentTriviaSyntax DocumentationCommentTrivia(SyntaxKind kind, SyntaxList<XmlNodeSyntax> content, SyntaxToken endOfComment)
    {
      ...
      return (DocumentationCommentTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DocumentationCommentTrivia(kind, content.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNodeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)endOfComment.Node).CreateRed();
    }
    ...
    public static TypeCrefSyntax TypeCref(TypeSyntax type)
    {
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (TypeCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.TypeCref(type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static QualifiedCrefSyntax QualifiedCref(TypeSyntax container, SyntaxToken dotToken, MemberCrefSyntax member)
    {
      ...
      return (QualifiedCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.QualifiedCref(container == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)container.Green, (Syntax.InternalSyntax.SyntaxToken)dotToken.Node, member == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.MemberCrefSyntax)member.Green).CreateRed();
    }
    ...
    public static NameMemberCrefSyntax NameMemberCref(TypeSyntax name, CrefParameterListSyntax parameters)
    {
      if (name == null)
        throw new ArgumentNullException(nameof(name));
      return (NameMemberCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.NameMemberCref(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)name.Green, parameters == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefParameterListSyntax)parameters.Green).CreateRed();
    }
    ...
    public static IndexerMemberCrefSyntax IndexerMemberCref(SyntaxToken thisKeyword, CrefBracketedParameterListSyntax parameters)
    {
      ...
      return (IndexerMemberCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IndexerMemberCref((Syntax.InternalSyntax.SyntaxToken)thisKeyword.Node, parameters == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefBracketedParameterListSyntax)parameters.Green).CreateRed();
    }
    ...
    public static OperatorMemberCrefSyntax OperatorMemberCref(SyntaxToken operatorKeyword, SyntaxToken operatorToken, CrefParameterListSyntax parameters)
    {
      ...
      return (OperatorMemberCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.OperatorMemberCref((Syntax.InternalSyntax.SyntaxToken)operatorKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)operatorToken.Node, parameters == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefParameterListSyntax)parameters.Green).CreateRed();
    }
    ...
    public static ConversionOperatorMemberCrefSyntax ConversionOperatorMemberCref(SyntaxToken implicitOrExplicitKeyword, SyntaxToken operatorKeyword, TypeSyntax type, CrefParameterListSyntax parameters)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (ConversionOperatorMemberCrefSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ConversionOperatorMemberCref((Syntax.InternalSyntax.SyntaxToken)implicitOrExplicitKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)operatorKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green, parameters == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefParameterListSyntax)parameters.Green).CreateRed();
    }
    ...
    public static CrefParameterListSyntax CrefParameterList(SyntaxToken openParenToken, SeparatedSyntaxList<CrefParameterSyntax> parameters, SyntaxToken closeParenToken)
    {
      ...
      return (CrefParameterListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CrefParameterList((Syntax.InternalSyntax.SyntaxToken)openParenToken.Node, parameters.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefParameterSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeParenToken.Node).CreateRed();
    }
    ...
    public static CrefBracketedParameterListSyntax CrefBracketedParameterList(SyntaxToken openBracketToken, SeparatedSyntaxList<CrefParameterSyntax> parameters, SyntaxToken closeBracketToken)
    {
      ...
      return (CrefBracketedParameterListSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CrefBracketedParameterList((Syntax.InternalSyntax.SyntaxToken)openBracketToken.Node, parameters.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefParameterSyntax>(), (Syntax.InternalSyntax.SyntaxToken)closeBracketToken.Node).CreateRed();
    }
    ...
    public static CrefParameterSyntax CrefParameter(SyntaxToken refKindKeyword, TypeSyntax type)
    {
      ...
      if (type == null)
        throw new ArgumentNullException(nameof(type));
      return (CrefParameterSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.CrefParameter((Syntax.InternalSyntax.SyntaxToken)refKindKeyword.Node, type == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.TypeSyntax)type.Green).CreateRed();
    }
    ...
    public static XmlElementSyntax XmlElement(XmlElementStartTagSyntax startTag, SyntaxList<XmlNodeSyntax> content, XmlElementEndTagSyntax endTag)
    {
      ...
      return (XmlElementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlElement(startTag == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlElementStartTagSyntax)startTag.Green, content.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNodeSyntax>(), endTag == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlElementEndTagSyntax)endTag.Green).CreateRed();
    }
    ...
    public static XmlElementStartTagSyntax XmlElementStartTag(SyntaxToken lessThanToken, XmlNameSyntax name, SyntaxList<XmlAttributeSyntax> attributes, SyntaxToken greaterThanToken)
    {
      ...
      return (XmlElementStartTagSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlElementStartTag((Syntax.InternalSyntax.SyntaxToken)lessThanToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, attributes.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlAttributeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)greaterThanToken.Node).CreateRed();
    }
    ...
    public static XmlEmptyElementSyntax XmlEmptyElement(SyntaxToken lessThanToken, XmlNameSyntax name, SyntaxList<XmlAttributeSyntax> attributes, SyntaxToken slashGreaterThanToken)
    {
      ...
      return (XmlEmptyElementSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlEmptyElement((Syntax.InternalSyntax.SyntaxToken)lessThanToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, attributes.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlAttributeSyntax>(), (Syntax.InternalSyntax.SyntaxToken)slashGreaterThanToken.Node).CreateRed();
    }
    ...
    public static XmlNameSyntax XmlName(XmlPrefixSyntax prefix, SyntaxToken localName)
    {
      ...
      return (XmlNameSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlName(prefix == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlPrefixSyntax)prefix.Green, (Syntax.InternalSyntax.SyntaxToken)localName.Node).CreateRed();
    }
    ...
    public static XmlPrefixSyntax XmlPrefix(SyntaxToken prefix, SyntaxToken colonToken)
    {
      ...
      return (XmlPrefixSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlPrefix((Syntax.InternalSyntax.SyntaxToken)prefix.Node, (Syntax.InternalSyntax.SyntaxToken)colonToken.Node).CreateRed();
    }
    ...
    public static XmlTextAttributeSyntax XmlTextAttribute(XmlNameSyntax name, SyntaxToken equalsToken, SyntaxToken startQuoteToken, SyntaxTokenList textTokens, SyntaxToken endQuoteToken)
    {
      ...
      return (XmlTextAttributeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlTextAttribute(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)equalsToken.Node, (Syntax.InternalSyntax.SyntaxToken)startQuoteToken.Node, textTokens.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)endQuoteToken.Node).CreateRed();
    }
    ...
    public static XmlCrefAttributeSyntax XmlCrefAttribute(XmlNameSyntax name, SyntaxToken equalsToken, SyntaxToken startQuoteToken, CrefSyntax cref, SyntaxToken endQuoteToken)
    {
      ...
      return (XmlCrefAttributeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlCrefAttribute(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)equalsToken.Node, (Syntax.InternalSyntax.SyntaxToken)startQuoteToken.Node, cref == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.CrefSyntax)cref.Green, (Syntax.InternalSyntax.SyntaxToken)endQuoteToken.Node).CreateRed();
    }
    ...
    public static XmlNameAttributeSyntax XmlNameAttribute(XmlNameSyntax name, SyntaxToken equalsToken, SyntaxToken startQuoteToken, IdentifierNameSyntax identifier, SyntaxToken endQuoteToken)
    {
      ...
      return (XmlNameAttributeSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlNameAttribute(name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, (Syntax.InternalSyntax.SyntaxToken)equalsToken.Node, (Syntax.InternalSyntax.SyntaxToken)startQuoteToken.Node, identifier == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.IdentifierNameSyntax)identifier.Green, (Syntax.InternalSyntax.SyntaxToken)endQuoteToken.Node).CreateRed();
    }
    ...
    {
      return (XmlTextSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlText(textTokens.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>()).CreateRed();
    }
    ...
    public static XmlCDataSectionSyntax XmlCDataSection(SyntaxToken startCDataToken, SyntaxTokenList textTokens, SyntaxToken endCDataToken)
    {
      ...
      return (XmlCDataSectionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlCDataSection((Syntax.InternalSyntax.SyntaxToken)startCDataToken.Node, textTokens.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)endCDataToken.Node).CreateRed();
    }
    ...
    public static XmlProcessingInstructionSyntax XmlProcessingInstruction(SyntaxToken startProcessingInstructionToken, XmlNameSyntax name, SyntaxTokenList textTokens, SyntaxToken endProcessingInstructionToken)
    {
      ...
      return (XmlProcessingInstructionSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.XmlProcessingInstruction((Syntax.InternalSyntax.SyntaxToken)startProcessingInstructionToken.Node, name == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.XmlNameSyntax)name.Green, textTokens.Node.ToGreenList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxToken>(), (Syntax.InternalSyntax.SyntaxToken)endProcessingInstructionToken.Node).CreateRed();
    }
    ...
    public static IfDirectiveTriviaSyntax IfDirectiveTrivia(SyntaxToken hashToken, SyntaxToken ifKeyword, ExpressionSyntax condition, SyntaxToken endOfDirectiveToken, bool isActive, bool branchTaken, bool conditionValue)
    {
      ...
      return (IfDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.IfDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)ifKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive, branchTaken, conditionValue).CreateRed();
    }
    ...
    public static ElifDirectiveTriviaSyntax ElifDirectiveTrivia(SyntaxToken hashToken, SyntaxToken elifKeyword, ExpressionSyntax condition, SyntaxToken endOfDirectiveToken, bool isActive, bool branchTaken, bool conditionValue)
    {
      ...
      return (ElifDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ElifDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)elifKeyword.Node, condition == null ? null : (StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax)condition.Green, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive, branchTaken, conditionValue).CreateRed();
    }
    ...
    public static EndIfDirectiveTriviaSyntax EndIfDirectiveTrivia(SyntaxToken hashToken, SyntaxToken endIfKeyword, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (EndIfDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EndIfDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)endIfKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static RegionDirectiveTriviaSyntax RegionDirectiveTrivia(SyntaxToken hashToken, SyntaxToken regionKeyword, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (RegionDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.RegionDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)regionKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static EndRegionDirectiveTriviaSyntax EndRegionDirectiveTrivia(SyntaxToken hashToken, SyntaxToken endRegionKeyword, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (EndRegionDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.EndRegionDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)endRegionKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static ErrorDirectiveTriviaSyntax ErrorDirectiveTrivia(SyntaxToken hashToken, SyntaxToken errorKeyword, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (ErrorDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ErrorDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)errorKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static WarningDirectiveTriviaSyntax WarningDirectiveTrivia(SyntaxToken hashToken, SyntaxToken warningKeyword, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (WarningDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.WarningDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)warningKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static BadDirectiveTriviaSyntax BadDirectiveTrivia(SyntaxToken hashToken, SyntaxToken identifier, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (BadDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.BadDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)identifier.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static DefineDirectiveTriviaSyntax DefineDirectiveTrivia(SyntaxToken hashToken, SyntaxToken defineKeyword, SyntaxToken name, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (DefineDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.DefineDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)defineKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)name.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static UndefDirectiveTriviaSyntax UndefDirectiveTrivia(SyntaxToken hashToken, SyntaxToken undefKeyword, SyntaxToken name, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (UndefDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.UndefDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)undefKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)name.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static PragmaWarningDirectiveTriviaSyntax PragmaWarningDirectiveTrivia(SyntaxToken hashToken, SyntaxToken pragmaKeyword, SyntaxToken warningKeyword, SyntaxToken disableOrRestoreKeyword, SyntaxToken nullableKeyword, SeparatedSyntaxList<ExpressionSyntax> errorCodes, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (PragmaWarningDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.PragmaWarningDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)pragmaKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)warningKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)disableOrRestoreKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)nullableKeyword.Node, errorCodes.Node.ToGreenSeparatedList<StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.ExpressionSyntax>(), (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static ReferenceDirectiveTriviaSyntax ReferenceDirectiveTrivia(SyntaxToken hashToken, SyntaxToken referenceKeyword, SyntaxToken file, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (ReferenceDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ReferenceDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)referenceKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)file.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static LoadDirectiveTriviaSyntax LoadDirectiveTrivia(SyntaxToken hashToken, SyntaxToken loadKeyword, SyntaxToken file, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (LoadDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.LoadDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)loadKeyword.Node, (Syntax.InternalSyntax.SyntaxToken)file.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
    ...
    public static ShebangDirectiveTriviaSyntax ShebangDirectiveTrivia(SyntaxToken hashToken, SyntaxToken exclamationToken, SyntaxToken endOfDirectiveToken, bool isActive)
    {
      ...
      return (ShebangDirectiveTriviaSyntax)StarkPlatform.Compiler.Stark.Syntax.InternalSyntax.SyntaxFactory.ShebangDirectiveTrivia((Syntax.InternalSyntax.SyntaxToken)hashToken.Node, (Syntax.InternalSyntax.SyntaxToken)exclamationToken.Node, (Syntax.InternalSyntax.SyntaxToken)endOfDirectiveToken.Node, isActive).CreateRed();
    }
