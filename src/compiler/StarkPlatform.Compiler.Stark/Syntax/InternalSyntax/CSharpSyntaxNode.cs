...
namespace StarkPlatform.Compiler.Stark.Syntax.InternalSyntax
{
    ...
    internal abstract class CSharpSyntaxNode : GreenNode
    {
        ...
        public override Compiler.SyntaxToken CreateSeparator<TNode>(SyntaxNode element)
        {
            return Stark.SyntaxFactory.Token(SyntaxKind.CommaToken);
        }
        ...
        /// </remarks>
        public override SyntaxNode GetStructure(StarkPlatform.Compiler.SyntaxTrivia trivia)
        {
            if (trivia.HasStructure)
            {
                ...
                if (parent != null)
                {
                    ...
                    lock (structsInParent)
                    {
                        ...
                        {
                            structure = Stark.Syntax.StructuredTriviaSyntax.Create(trivia);
                ...
                {
                    return Stark.Syntax.StructuredTriviaSyntax.Create(trivia);
                }
            }
