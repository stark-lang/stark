...
namespace StarkPlatform.Compiler.Stark.Syntax.InternalSyntax
{
    internal class SyntaxTrivia : CSharpSyntaxNode
    {
        ...
        public static implicit operator StarkPlatform.Compiler.SyntaxTrivia(SyntaxTrivia trivia)
        {
            return new StarkPlatform.Compiler.SyntaxTrivia(default(StarkPlatform.Compiler.SyntaxToken), trivia, position: 0, index: 0);
        }
