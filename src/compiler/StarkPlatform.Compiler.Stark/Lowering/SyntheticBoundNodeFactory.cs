...
using StarkPlatform.Compiler.Stark.CodeGen;
...
namespace StarkPlatform.Compiler.Stark
{
    ...
    internal sealed class SyntheticBoundNodeFactory
    {
        ...
        public BoundIsOperator Is(BoundExpression operand, TypeSymbol type)
        {
            ...
            return new BoundIsOperator(this.Syntax, operand, Type(type), c, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean)) { WasCompilerGenerated = true };
        }

        public BoundBinaryOperator LogicalAnd(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.LogicalBoolAnd, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator LogicalOr(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.LogicalBoolOr, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32Equal, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator ObjectEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.ObjectEqual, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator ObjectNotEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.ObjectNotEqual, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntNotEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32NotEqual, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntLessThan(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32LessThan, SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundBinaryOperator IntGreaterThanOrEqual(BoundExpression left, BoundExpression right)
        {
            return Binary(BinaryOperatorKind.Int32GreaterThanOrEqual, SpecialType(Compiler.SpecialType.System_Boolean), left, right);
        }

        public BoundLiteral Literal(int value)
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.Compiler.SpecialType.System_Int32)) { WasCompilerGenerated = true };
        }

        public BoundLiteral Literal(uint value)
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.Compiler.SpecialType.System_UInt32)) { WasCompilerGenerated = true };
        }
        ...
        {
            Debug.Assert(ex.Type.SpecialType == Compiler.SpecialType.System_Int32);
        ...
        {
            return new BoundLiteral(Syntax, ConstantValue.Create(value), SpecialType(StarkPlatform.Compiler.SpecialType.System_Boolean)) { WasCompilerGenerated = true };
        }
        ...
        public BoundLiteral StringLiteral(ConstantValue stringConst)
        {
            ...
            return new BoundLiteral(Syntax, stringConst, SpecialType(StarkPlatform.Compiler.SpecialType.System_String)) { WasCompilerGenerated = true };
        }
        ...
        {
            return new BoundSizeOfOperator(Syntax, Type(type), Binder.GetConstantSizeOf(type), SpecialType(StarkPlatform.Compiler.SpecialType.System_Int32)) { WasCompilerGenerated = true };
        }
        ...
        public BoundExpression MethodDefIndex(MethodSymbol method)
        {
            return new BoundMethodDefIndex(
                Syntax,
                method,
                SpecialType(StarkPlatform.Compiler.SpecialType.System_Int32))
            { WasCompilerGenerated = true };
        }
        ...
        {
            return new BoundModuleVersionIdString(Syntax, SpecialType(StarkPlatform.Compiler.SpecialType.System_String)) { WasCompilerGenerated = true };
        }
        ...
        public BoundExpression MethodInfo(MethodSymbol method)
        {
            ...
            if (!method.ContainingType.IsValueType || !StarkPlatform.Compiler.Stark.CodeGen.CodeGenerator.MayUseCallForStructMethod(method))
            {
        ...
        private MethodSymbol GetMethodFromHandleMethod(NamedTypeSymbol methodContainer)
        {
            return WellKnownMethod(
                ...
                Compiler.WellKnownMember.System_Reflection_MethodBase__GetMethodFromHandle :
                Compiler.WellKnownMember.System_Reflection_MethodBase__GetMethodFromHandle2);
        }
        ...
        private MethodSymbol GetFieldFromHandleMethod(NamedTypeSymbol fieldContainer)
        {
            return WellKnownMethod(
                ...
                Compiler.WellKnownMember.System_Reflection_FieldInfo__GetFieldFromHandle :
                Compiler.WellKnownMember.System_Reflection_FieldInfo__GetFieldFromHandle2);
        }
        ...
        public BoundExpression ArrayOrEmpty(TypeSymbol elementType, ImmutableArray<BoundExpression> elements)
        {
            ...
            {
                MethodSymbol arrayEmpty = WellKnownMethod(Compiler.WellKnownMember.System_Array__Empty, isOptional: true);
