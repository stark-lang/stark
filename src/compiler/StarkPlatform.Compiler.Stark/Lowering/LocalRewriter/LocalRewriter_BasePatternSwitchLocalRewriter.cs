    ...
    internal partial class LocalRewriter
    {
        ...
        private class BaseSwitchLocalRewriter : PatternLocalRewriter
        {
            ...
            private void EnsureStringHashFunction(int labelsCount, SyntaxNode syntaxNode)
            {
                ...
                if (!Compiler.CodeGen.SwitchStringJumpTableEmitter.ShouldGenerateHashTableSwitch(module, labelsCount))
                {
                    return;
                }
                ...
                if (privateImplClass.GetMethod(Compiler.CodeGen.PrivateImplementationDetails.SynthesizedStringHashFunctionName) != null)
                {
                    return;
                }
