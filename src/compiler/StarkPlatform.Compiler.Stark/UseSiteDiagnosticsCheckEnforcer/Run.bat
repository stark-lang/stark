...
@findstr /C:StarkPlatform.Compiler.Stark.Symbols.TypeSymbol::get_BaseType() %ILFileName% > Found.txt
@findstr /C:StarkPlatform.Compiler.Stark.Symbols.TypeSymbol::get_Interfaces() %ILFileName% >> Found.txt
@findstr /C:StarkPlatform.Compiler.Stark.Symbols.TypeSymbol::get_AllInterfaces() %ILFileName% >> Found.txt
@findstr /C:StarkPlatform.Compiler.Stark.Symbols.NamedTypeSymbol::get_TypeArguments() %ILFileName% >> Found.txt
@findstr /C:StarkPlatform.Compiler.Stark.Symbols.TypeParameterSymbol::get_ConstraintTypes() %ILFileName% >> Found.txt
