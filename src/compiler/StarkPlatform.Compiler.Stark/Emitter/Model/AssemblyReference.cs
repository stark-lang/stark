...
namespace StarkPlatform.Compiler.Stark.Emit
{
    internal sealed class AssemblyReference : Cci.IAssemblyReference
    {
        ...
        Cci.IAssemblyReference Cci.IModuleReference.GetContainingAssembly(Compiler.Emit.EmitContext context)
        {
            return this;
        }

        IEnumerable<Cci.ICustomAttribute> Cci.IReference.GetAttributes(Compiler.Emit.EmitContext context)
        {
            return SpecializedCollections.EmptyEnumerable<Cci.ICustomAttribute>();
        }

        Cci.IDefinition Cci.IReference.AsDefinition(Compiler.Emit.EmitContext context)
        {
            return null;
        }
    }
