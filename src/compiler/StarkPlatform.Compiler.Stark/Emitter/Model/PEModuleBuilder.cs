...
namespace StarkPlatform.Compiler.Stark.Emit
{
    internal abstract class PEModuleBuilder : PEModuleBuilder<CSharpCompilation, SourceModuleSymbol, AssemblySymbol, TypeSymbol, NamedTypeSymbol, MethodSymbol, SyntaxNode, NoPia.EmbeddedTypesManager, ModuleCompilationState>
    {
                   ...
                   new ModuleCompilationState())
        {
            ...
            _metadataName = specifiedName != StarkPlatform.Compiler.Compilation.UnspecifiedModuleAssemblyName ?
                            specifiedName :
        ...
        {
            NamedTypeSymbol systemTypeSymbol = Compilation.GetWellKnownType(WellKnownType.core_Type);
        ...
        public sealed override bool IsPlatformType(Cci.ITypeReference typeRef, Cci.PlatformType platformType)
        {
            ...
            if ((object)namedType != null)
            {
                ...
                {
                    return (object)namedType == (object)Compilation.GetWellKnownType(WellKnownType.core_Type);
                }
        ...
        protected sealed override Cci.IAssemblyReference GetCorLibraryReferenceToEmit(Compiler.Emit.EmitContext context)
        {
            ...
            bool needDeclaration = false)
        {
            ...
            if (namedTypeSymbol.OriginalDefinition.Kind == SymbolKind.ErrorType)
            {
                ...
                return Compiler.Emit.ErrorType.Singleton;
            }
