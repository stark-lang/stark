...
namespace StarkPlatform.Compiler.Stark.Symbols
{
    ...
    internal sealed partial class AnonymousTypeManager
    {
        ...
        private AnonymousTypeTemplateSymbol CreatePlaceholderTemplate(StarkPlatform.Compiler.Emit.AnonymousTypeKey key)
        {
        ...
        internal static StarkPlatform.Compiler.Emit.AnonymousTypeKey GetAnonymousTypeKey(NamedTypeSymbol type)
        {
            return ((AnonymousTypeTemplateSymbol)type).GetAnonymousTypeKey();
        }

        internal IReadOnlyDictionary<StarkPlatform.Compiler.Emit.AnonymousTypeKey, StarkPlatform.Compiler.Emit.AnonymousTypeValue> GetAnonymousTypeMap()
        {
            var result = new Dictionary<StarkPlatform.Compiler.Emit.AnonymousTypeKey, StarkPlatform.Compiler.Emit.AnonymousTypeValue>();
            ...
            foreach (var template in templates)
            {
                ...
                var value = new StarkPlatform.Compiler.Emit.AnonymousTypeValue(nameAndIndex.Name, nameAndIndex.Index, template);
