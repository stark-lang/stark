...
namespace StarkPlatform.Compiler.Stark.Symbols
{
    internal sealed partial class DynamicTypeSymbol : TypeSymbol, IDynamicTypeSymbol
    {
        ...
        public override int GetHashCode()
        {
            ...
            return (int)StarkPlatform.Compiler.SpecialType.System_Object;
        }
        ...
        internal override bool Equals(TypeSymbol t2, TypeCompareKind comparison)
        {
            ...
            if ((comparison & TypeCompareKind.IgnoreDynamic) != 0)
            {
                ...
                return (object)other != null && other.SpecialType == StarkPlatform.Compiler.SpecialType.System_Object;
            }
