...
using StarkPlatform.CodeAnalysis.IntroduceVariable;
using StarkPlatform.CodeAnalysis.Shared.Extensions;

namespace StarkPlatform.CodeAnalysis.Stark.IntroduceVariable
{
    [ExportLanguageService(typeof(IIntroduceVariableService), LanguageNames.Stark), Shared]
        ...
        AbstractIntroduceVariableService<CSharpIntroduceVariableService, ExpressionSyntax, TypeSyntax, TypeDeclarationSyntax, QueryExpressionSyntax, NameSyntax>
    {
        ...
        protected override bool IsInAttributeArgumentInitializer(ExpressionSyntax expression)
        {
            ...
            if (attributeArgument != null)
            {
                ...
                {
                    var attributeDecl = attributeArgument.GetAncestorOrThis<AttributeSyntax>();
