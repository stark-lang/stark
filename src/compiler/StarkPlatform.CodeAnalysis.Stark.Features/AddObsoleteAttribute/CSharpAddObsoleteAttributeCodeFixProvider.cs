...
using StarkPlatform.CodeAnalysis.AddObsoleteAttribute;
using StarkPlatform.CodeAnalysis.CodeFixes;

namespace StarkPlatform.CodeAnalysis.Stark.AddObsoleteAttribute
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = nameof(CSharpAddObsoleteAttributeCodeFixProvider)), Shared]
