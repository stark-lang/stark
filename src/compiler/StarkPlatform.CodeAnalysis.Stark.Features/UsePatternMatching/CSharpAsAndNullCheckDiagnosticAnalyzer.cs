...
using StarkPlatform.CodeAnalysis.Stark.ExtractMethod;
                ...
                case SyntaxKind.IdentifierName:
                    {
                        ...
                        if (!initializerValue.IsKind(SyntaxKind.AsOptExpression, out asExpression))
                        {
                            break;
                        }
                ...
                case SyntaxKind.SimpleAssignmentExpression:
                    {
                        ...
                        if (!assignment.Right.IsKind(SyntaxKind.AsOptExpression, out asExpression) ||
