        ...
        where TDeclaration : SyntaxNode
    {
            ...
            out SyntaxToken semicolonToken)
        {
                ...
                BlockSyntaxExtensions.MatchesPreference(getAccessor.ExpressionBody.Expression, conversionPreference))
            {
                ...
                semicolonToken = getAccessor.EosToken;
                return true;
            }
        ...
        protected abstract SyntaxToken GetEosToken(TDeclaration declaration);
            ...
            SemanticModel semanticModel, TDeclaration declaration, OptionSet options, ParseOptions parseOptions)
        {
            ...
            var semicolonToken = GetEosToken(declaration);

            if (expressionBody.TryConvertToBlock(
                    GetEosToken(declaration),
