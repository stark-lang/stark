...
using StarkPlatform.CodeAnalysis.GenerateMember.GenerateVariable;
using StarkPlatform.CodeAnalysis.Shared.Extensions;

namespace StarkPlatform.CodeAnalysis.Stark.GenerateVariable
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.GenerateVariable), Shared]
