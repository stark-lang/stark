...
namespace StarkPlatform.CodeAnalysis.Stark.GenerateConstructor
{
    ...
    /// </summary>
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.GenerateConstructor), Shared]
