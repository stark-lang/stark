...
using StarkPlatform.CodeAnalysis.UseAutoProperty;

namespace StarkPlatform.CodeAnalysis.Stark.UseAutoProperty
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = nameof(CSharpUseAutoPropertyCodeFixProvider)), Shared]
        ...
        : AbstractUseAutoPropertyCodeFixProvider<TypeDeclarationSyntax, PropertyDeclarationSyntax, VariableDeclarationSyntax, ConstructorDeclarationSyntax, ExpressionSyntax>
    {
        protected override SyntaxNode GetNodeToRemove(VariableDeclarationSyntax declarator)
        {
            ...
            var nodeToRemove = (SyntaxNode)fieldDeclaration;
            return nodeToRemove;
        }
            ...
            PropertyDeclarationSyntax propertyDeclaration, bool isWrittenOutsideOfConstructor, CancellationToken cancellationToken)
        {
            ...
            var updatedProperty = propertyDeclaration.WithAccessorList(UpdateAccessorList(propertyDeclaration.AccessorList))
                                                     ...
                                                     .WithEosToken(SyntaxFactory.Token(SyntaxKind.None));
