...
using StarkPlatform.CodeAnalysis.UseObjectInitializer;

namespace StarkPlatform.CodeAnalysis.Stark.UseObjectInitializer
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.UseObjectInitializer), Shared]
