...
namespace StarkPlatform.CodeAnalysis.Stark.Diagnostics.SimplifyTypeNames
{
        ...
        : SimplifyTypeNamesDiagnosticAnalyzerBase<SyntaxKind>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                var expressionToCheck = expression.Kind() == SyntaxKind.AsOptExpression || expression.Kind() == SyntaxKind.IsExpression
