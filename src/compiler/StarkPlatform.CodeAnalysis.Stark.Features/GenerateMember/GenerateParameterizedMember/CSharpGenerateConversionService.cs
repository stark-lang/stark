...
using StarkPlatform.CodeAnalysis.Stark.GenerateMember.GenerateMethod;
...
namespace StarkPlatform.CodeAnalysis.Stark.GenerateMember.GenerateParameterizedMember
{
