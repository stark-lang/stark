...
namespace StarkPlatform.CodeAnalysis.Stark.GenerateMember.GenerateVariable
{
    [ExportLanguageService(typeof(IGenerateVariableService), LanguageNames.Stark), Shared]
