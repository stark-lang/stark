...
namespace StarkPlatform.CodeAnalysis.Stark.EditAndContinue
{
    internal static class BreakpointSpans
    {
        ...
        {
            return TryCreateSpanForVariableDeclaration(fieldDeclaration.Declaration, fieldDeclaration.EosToken, position);
        }
        ...
        private static TextSpan? TryCreateSpanForStatement(StatementSyntax statement, int position)
        {
            ...
            switch (statement.Kind())
            {
                ...
                case SyntaxKind.LocalDeclarationStatement:
                    ...
                    return TryCreateSpanForVariableDeclaration(declarationStatement.Declaration, declarationStatement.EosToken, position);
                ...
                case SyntaxKind.IfStatement:
                    ...
                    return CreateSpan(ifStatement, ifStatement.Condition.GetLastToken());
        ...
        private static TextSpan? TryCreateSpanForVariableDeclaration(VariableDeclarationSyntax declaration, int position)
        {
            ...
            return TryCreateSpanForVariableDeclaration(declaration, default, position);
        }
        ...
        private static TextSpan? TryCreateSpanForVariableDeclaration(
            ...
            int position)
        {
            if (variableDeclaration.VariableKeyword.Kind() == SyntaxKind.ConstKeyword)
            {
            ...
            return CreateSpan(variableDeclaration, semicolonOpt);
        }
