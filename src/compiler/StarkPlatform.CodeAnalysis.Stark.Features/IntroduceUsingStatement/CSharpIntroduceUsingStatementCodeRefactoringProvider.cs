...
using StarkPlatform.CodeAnalysis.IntroduceUsingStatement;
using Roslyn.Utilities;

namespace StarkPlatform.CodeAnalysis.Stark.IntroduceUsingStatement
{
    [ExtensionOrder(Before = PredefinedCodeRefactoringProviderNames.IntroduceVariable)]
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = PredefinedCodeRefactoringProviderNames.IntroduceUsingStatement), Shared]
