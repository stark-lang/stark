...
using StarkPlatform.CodeAnalysis.MakeMethodSynchronous;
using StarkPlatform.CodeAnalysis.Shared.Extensions;
using static StarkPlatform.CodeAnalysis.MakeMethodAsynchronous.AbstractMakeMethodAsynchronousCodeFixProvider;

namespace StarkPlatform.CodeAnalysis.Stark.MakeMethodSynchronous
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.MakeMethodSynchronous), Shared]
