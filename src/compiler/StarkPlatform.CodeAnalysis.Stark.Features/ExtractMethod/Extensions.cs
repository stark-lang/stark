...
namespace StarkPlatform.CodeAnalysis.Stark.ExtractMethod
{
    internal static class Extensions
    {
        ...
        {
            return node.PartOfConstantInitializerExpression<FieldDeclarationSyntax>(n => n.Declaration.VariableKeyword.Kind() == SyntaxKind.ConstKeyword) ||
                   node.PartOfConstantInitializerExpression<LocalDeclarationStatementSyntax>(n => n.Declaration.VariableKeyword.Kind() == SyntaxKind.ConstKeyword);
        }

        private static bool PartOfConstantInitializerExpression<T>(this SyntaxNode node, Func<T, bool> isConst) where T : SyntaxNode
        {
