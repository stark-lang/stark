...
namespace StarkPlatform.CodeAnalysis.Stark.ReplaceDefaultLiteral
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.ReplaceDefaultLiteral), Shared]
