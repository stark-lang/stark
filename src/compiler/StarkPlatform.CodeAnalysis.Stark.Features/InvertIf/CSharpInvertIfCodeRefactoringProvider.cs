...
using StarkPlatform.CodeAnalysis.InvertIf;
using StarkPlatform.CodeAnalysis.Shared.Extensions;
using StarkPlatform.CodeAnalysis.Text;
using Roslyn.Utilities;

namespace StarkPlatform.CodeAnalysis.Stark.InvertIf
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = PredefinedCodeRefactoringProviderNames.InvertIf), Shared]
    internal sealed class CSharpInvertIfCodeRefactoringProvider : AbstractInvertIfCodeRefactoringProvider<IfStatementSyntax, StatementSyntax, StatementSyntax>
    {
            ...
            StatementSyntax falseStatementOpt = null)
        {
            ...
            var updatedIf = ifNode
                ...
                .WithStatement(SyntaxFactory.Block(trueStatement));
