...
using StarkPlatform.CodeAnalysis.ReplacePropertyWithMethods;
using Roslyn.Utilities;

namespace StarkPlatform.CodeAnalysis.Stark.ReplacePropertyWithMethods
{
    [ExportLanguageService(typeof(IReplacePropertyWithMethodsService), LanguageNames.Stark), Shared]
            ...
            CancellationToken cancellationToken)
        {
            ...
            else if (setAccessorDeclaration.ExpressionBody != null)
            {
                return methodDeclaration.WithBody(null)
                                        ...
                                        .WithEosToken(setAccessorDeclaration.EosToken);
            }
            ...
            MethodDeclarationSyntax methodDeclaration, bool createReturnStatementForExpression)
        {
            ...
            else if (methodDeclaration?.ExpressionBody != null && expressionBodyPreference == ExpressionBodyPreference.Never)
            {
                if (methodDeclaration.ExpressionBody.TryConvertToBlock(
                        methodDeclaration.EosToken, createReturnStatementForExpression, out var block))
                {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (propertyDeclaration.ExpressionBody != null)
            {
                return methodDeclaration.WithBody(null)
                                        ...
                                        .WithEosToken(propertyDeclaration.EosToken);
            }
            else
            {
                ...
                if (getAccessorDeclaration?.ExpressionBody != null)
                {
                    return methodDeclaration.WithBody(null)
                                            ...
                                            .WithEosToken(getAccessorDeclaration.EosToken);
                }
