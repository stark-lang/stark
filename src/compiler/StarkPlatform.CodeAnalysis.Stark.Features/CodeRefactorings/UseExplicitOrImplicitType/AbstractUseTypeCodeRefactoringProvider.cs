...
namespace StarkPlatform.CodeAnalysis.Stark.CodeRefactorings.UseType
{
    internal abstract class AbstractUseTypeCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            Debug.Assert(declaration.IsKind(SyntaxKind.VariableDeclaration, SyntaxKind.DeclarationExpression));
        ...
        private static SyntaxNode GetDeclaration(SyntaxNode root, TextSpan textSpan)
        {
            ...
            return token.Parent?.FirstAncestorOrSelf<SyntaxNode>(
                a => a.IsKind(SyntaxKind.DeclarationExpression, SyntaxKind.VariableDeclaration));
        }
