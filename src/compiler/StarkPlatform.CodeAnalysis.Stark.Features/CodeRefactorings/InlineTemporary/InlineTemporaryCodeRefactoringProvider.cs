...
namespace StarkPlatform.CodeAnalysis.Stark.CodeRefactorings.InlineTemporary
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = PredefinedCodeRefactoringProviderNames.InlineTemporary), Shared]
