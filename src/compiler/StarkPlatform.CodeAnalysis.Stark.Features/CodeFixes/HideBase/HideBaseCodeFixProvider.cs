...
namespace StarkPlatform.CodeAnalysis.Stark.CodeFixes.HideBase
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.AddNew), Shared]
