...
namespace StarkPlatform.CodeAnalysis.Stark.CodeFixes.ConditionalExpressionInStringInterpolation
{
    [ExportCodeFixProvider(LanguageNames.Stark, Name = PredefinedCodeFixProviderNames.AddParenthesesAroundConditionalExpressionInInterpolatedString), Shared]
