...
using StarkPlatform.CodeAnalysis.UseNamedArguments;

namespace StarkPlatform.CodeAnalysis.Stark.UseNamedArguments
{
    [ExtensionOrder(After = PredefinedCodeRefactoringProviderNames.IntroduceVariable)]
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = nameof(CSharpUseNamedArgumentsCodeRefactoringProvider)), Shared]
