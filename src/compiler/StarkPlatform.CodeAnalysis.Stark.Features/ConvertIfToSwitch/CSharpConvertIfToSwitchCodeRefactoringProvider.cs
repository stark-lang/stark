...
using StarkPlatform.CodeAnalysis.ConvertIfToSwitch;
using StarkPlatform.CodeAnalysis.Shared.Extensions;

namespace StarkPlatform.CodeAnalysis.Stark.ConvertIfToSwitch
{
    [ExportCodeRefactoringProvider(LanguageNames.Stark, Name = nameof(CSharpConvertIfToSwitchCodeRefactoringProvider)), Shared]
        ...
        private sealed class CSharpAnalyzer : Analyzer<StatementSyntax, IfStatementSyntax, ExpressionSyntax, CasePatternSwitchLabelSyntax>
        {
            ...
            protected override ExpressionSyntax UnwrapCast(ExpressionSyntax expression)
            {
                switch (expression)
                {
                    case BinaryExpressionSyntax binaryExpression
                        when expression.IsKind(SyntaxKind.AsOptExpression):
                ...
                IfStatementSyntax ifStatement, ExpressionSyntax expression, List<SyntaxNode> sectionList)
            {
                ...
                return SyntaxFactory.SwitchStatement(
                    ...
                    expression,
                    SyntaxFactory.Token(SyntaxKind.CloseParenToken).WithPrependedLeadingTrivia(SyntaxFactory.ElasticMarker),
