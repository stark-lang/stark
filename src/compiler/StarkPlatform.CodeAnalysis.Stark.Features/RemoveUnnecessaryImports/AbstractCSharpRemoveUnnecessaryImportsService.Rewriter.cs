...
namespace StarkPlatform.CodeAnalysis.Stark.RemoveUnnecessaryImports
{
    internal partial class AbstractCSharpRemoveUnnecessaryImportsService
    {
        ...
        {
            private readonly ISet<ImportDirectiveSyntax> _unnecessaryUsingsDoNotAccessDirectly;
            ...
            public Rewriter(
                ...
                Document document,
                ISet<ImportDirectiveSyntax> unnecessaryUsings,
            ...
            private void ProcessUsings(
                SyntaxList<ImportDirectiveSyntax> usings,
                ISet<ImportDirectiveSyntax> usingsToRemove,
                out SyntaxList<ImportDirectiveSyntax> finalUsings,
                out SyntaxTriviaList finalTrivia)
            {
                var currentUsings = new List<ImportDirectiveSyntax>(usings);
            ...
            private ISet<ImportDirectiveSyntax> GetUsingsToRemove(
                SyntaxList<ImportDirectiveSyntax> oldUsings,
                SyntaxList<ImportDirectiveSyntax> newUsings)
            {
                Debug.Assert(oldUsings.Count == newUsings.Count);

                var result = new HashSet<ImportDirectiveSyntax>();
